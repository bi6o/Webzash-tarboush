 ...
 *
 * @param CakeText $key The keyname for this logger, used to remove the
 *    logger later.
 ...
 *
 * @param CakeText $streamName Key name of a configured stream to remove.
 * @return void
 */
 ...
 *
 * @param CakeText $streamName to check
 * @return bool
 * @throws CakeLogException
 */
 ...
 *
 * @param CakeText $streamName to enable
 * @return void
 * @throws CakeLogException
 */
 ...
 * its re-enabled.
 *
 * @param CakeText $streamName to disable
 * @return void
 * @throws CakeLogException
 */
 ...
 *
 * @param CakeText $streamName Key name of a configured stream to get.
 ...
 *
 * @param int|CakeText $type Type of message being written. When value is an integer
 *    or a string matching the recognized levels, then it will
 *    be treated log levels. Otherwise it's treated as scope.
 * @param CakeText $message Message content to log
 * @param CakeText|array $scope The scope(s) a log message is being created in.
 ...
 *
 * @param CakeText $message log message
 * @param CakeText|array $scope The scope(s) a log message is being created in.
 *    See CakeLog::config() for more information on logging scopes.
 * @return bool Success
 */
