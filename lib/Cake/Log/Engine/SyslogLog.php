 ...
 *
 * @param CakeText $type The type of log you are making.
 * @param CakeText $message The message you want to log.
 ...
 *
 * @param CakeText $ident the prefix to add to all messages logged
 ...
 * @param CakeText $message Message to log.
 * @return bool
 */
