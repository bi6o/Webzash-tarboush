 ...
 *
 * @param CakeText $haystack The string from which to get the position of the first occurrence of $needle.
 * @param CakeText $needle The string to find in $haystack.
 * @param int $offset The position in $haystack to start searching.
 * @param CakeText $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 ...
 *
 * @param CakeText $haystack The string from which to get the first occurrence of $needle.
 * @param CakeText $needle The string to find in $haystack.
 ...
 * @param CakeText $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return CakeText|bool The portion of $haystack, or false if $needle is not found.
 */
 ...
 * Get string length.
 *
 * @param CakeText $string The string being checked for length.
 * @param CakeText $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 ...
 *
 * @param CakeText $haystack The string being checked.
 * @param CakeText $needle The position counted from the beginning of haystack.
 ...
 *
 * @param CakeText $haystack The string from which to get the last occurrence of $needle.
 * @param CakeText $needle The string to find in $haystack.
 * @param bool $part Determines which portion of $haystack this function returns.
 ...
 *
 * @param CakeText $haystack The string from which to get the position of the last occurrence of $needle.
 * @param CakeText $needle The string to find in $haystack.
 * @param int $offset The position in $haystack to start searching.
 * @param CakeText $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 ...
 *
 * @param CakeText $haystack The string being checked, for the last occurrence of $needle.
 * @param CakeText $needle The string to find in $haystack.
 ...
 *    Default value is FALSE.
 * @param CakeText $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return CakeText|bool The portion of $haystack, or true if $needle is not found.
 */
 ...
 *
 * @param CakeText $string The string being lowercased.
 * @param CakeText $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return CakeText with all alphabetic characters converted to lowercase.
 */
 ...
 *
 * @param CakeText $string The string being uppercased.
 * @param CakeText $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return CakeText with all alphabetic characters converted to uppercase.
 */
 ...
 *
 * @param CakeText $haystack The string being checked.
 * @param CakeText $needle The string being found.
 * @param CakeText $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 ...
 * Get part of string
 *
 * @param CakeText $string The string being checked.
 * @param int $start The first position used in $string.
 * @param int $length The maximum length of the returned string.
 * @param CakeText $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return CakeText The portion of $string specified by the $string and $length parameters.
 */
 ...
 *
 * @param CakeText $str The string being encoded
 * @param CakeText $charset specifies the name of the character set in which str is represented in.
 *    The default value is determined by the current NLS setting (mbstring.language).
 * @param CakeText $transferEncoding specifies the scheme of MIME encoding.
 *    It should be either "B" (Base64) or "Q" (Quoted-Printable). Falls back to "B" if not given.
 * @param CakeText $linefeed specifies the EOL (end-of-line) marker with which
 ...
 * @return CakeText A converted version of the string represented in ASCII.
 */
