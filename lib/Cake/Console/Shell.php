 ...
 *
 * @param CakeText $name The name of the model to look for.
 * @return void
 */
 ...
 *
 * @param CakeText $modelClass Name of model class to load
 ...
 *
 * @param CakeText $task The task name to check.
 * @return bool Success
 ...
 *
 * @param CakeText $name The method name to check.
 * @return bool
 ...
 *
 * @param CakeText $command The command name to run on this shell. If this argument is empty,
 ...
 *
 * @param CakeText $command The command to get help for.
 * @return void
 */
 ...
 *
 * @param CakeText $name The property name to access.
 ...
 *
 * @param CakeText $prompt Prompt text.
 * @param CakeText|array $options Array or string of options.
 * @param CakeText $default Default input value.
 ...
 *
 * @param CakeText $text Text the text to format.
 * @param CakeText|int|array $options Array of options to use, or an integer to wrap the text to.
 * @return CakeText Wrapped / indented text
 * @see String::wrap()
 ...
 *
 * @param CakeText|array $message A string or an array of strings to output
 ...
 *
 * @param CakeText $title Title of the error
 * @param CakeText $message An optional error message
 * @return void
 ...
 *
 * @param CakeText $path Where to put the file.
 * @param CakeText $contents Content to put in the file.
 * @return bool Success
 ...
 *
 * @param CakeText $file Absolute file path
 * @return CakeText short path
 ...
 *
 * @param CakeText $name Controller class name
 * @return CakeText Path to controller
 */
 ...
 *
 * @param CakeText $name Controller class name
 * @return CakeText Controller plural name
 */
 ...
 * @return CakeText Camelized and singularized model name
 */
 ...
 *
 * @param CakeText $name Model class name
 * @return CakeText Singular model key
 */
 ...
 *
 * @param CakeText $key Foreign key
 * @return CakeText Model name
 */
 ...
 *
 * @param CakeText $name The plural underscored value.
 * @return CakeText name
 */
 ...
 *
 * @param CakeText $name Name to use
 * @return CakeText Plural name for views
 */
 ...
 *
 * @param CakeText $name Controller name
 * @return CakeText Singular human name
 */
 ...
 *
 * @param CakeText $name Controller name
 * @return CakeText Plural human name
 */
 ...
 *
 * @param CakeText $pluginName Name of the plugin you want ie. DebugKit
 * @return CakeText path path to the correct plugin.
 */
