 ...
 *
 * @param CakeText|array $name The long name of the option, or an array with all the properties.
 * @param CakeText $short The short alias for this option
 * @param CakeText $help The help text for this option
 * @param bool $boolean Whether this option is a boolean option. Boolean options don't consume extra tokens
 * @param CakeText $default The default value for this option.
 ...
 *
 * @return CakeText Value of this->_name.
 */
 ...
 *
 * @return CakeText Value of this->_short.
 */
 ...
 *
 * @param CakeText $value The choice to validate.
 * @return bool
 * @throws ConsoleException
 */
