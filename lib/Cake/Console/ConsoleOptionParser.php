 ...
 *
 * @param CakeText $command The command name this parser is for. The command name is used for generating help.
 ...
 *
 * @param CakeText $text The text to set, or null if you want to read
 * @return CakeText|$this If reading, the value of the command. If setting $this will be returned.
 */
 ...
 *
 * @param CakeText|array $text The text to set, or null if you want to read. If an array the
 *   text will be imploded with "\n"
 * @return CakeText|$this If reading, the value of the description. If setting $this will be returned.
 */
 ...
 *
 * @param CakeText|array $text Text when setting or null when reading. If an array the text will be imploded with "\n"
 * @return CakeText|$this If reading, the value of the epilog. If setting $this will be returned.
 */
 ...
 *
 * @param ConsoleInputOption|CakeText $name The long name you want to the value to be parsed out as when options are parsed.
 ...
 *   An exception will be raised when parse() encounters an invalid value.
 *
 * @param ConsoleInputArgument|CakeText $name The name of the argument. Will also accept an instance of ConsoleInputArgument
 ...
 *    it will be used.
 *
 * @param ConsoleInputSubcommand|CakeText $name Name of the subcommand. Will also accept an instance of ConsoleInputSubcommand
 ...
 * @param CakeText $command The subcommand to use. If this parameter is a subcommand, that has a parser,
 ...
 * in the parser.
 *
 * @param CakeText $subcommand If present and a valid subcommand that has a linked parser.
 *    That subcommands help will be shown instead.
 * @param CakeText $format Define the output format, can be text or xml
 * @param int $width The width to format user content to. Defaults to 72
 * @return CakeText Generated help.
 */
 ...
 *
 * @param CakeText $option The option to parse.
 ...
 *
 * @param CakeText $name The name to parse.
 * @param array $params The params to append the parsed value into
 * @return array Params with $option added in.
 ...
 *
 * @param CakeText $name The name of the option.
 * @return bool
 */
 ...
 *
 * @param CakeText $argument The argument to append
