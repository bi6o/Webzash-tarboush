 ...
 *
 * @param CakeText $stream The identifier of the stream to write output to.
 */
 ...
 *
 * @param CakeText $text Text with styling tags.
 * @return CakeText String with color codes added.
 */
 ...
 *
 * @param CakeText $message Message to write.
 * @return bool success
 */
 ...
 *
 * @param CakeText $style The style to get or create.
