 ...
 *
 * @param CakeText $class Class name that is being used.
 ...
 *
 * @param CakeText $identifier Identifier to parse
 ...
 *
 * @param CakeText $class Class type you want (Aro/Aco)
 * @param CakeText|array $identifier A mixed identifier for finding the node.
 ...
 *
 * @param CakeText $type Node type  (ARO/ACO)
