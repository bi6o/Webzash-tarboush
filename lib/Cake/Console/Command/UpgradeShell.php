 ...
 *
 * @param CakeText $path The path to move files in.
 ...
 *
 * @param CakeText $extensions The extensions to include. Defaults to none.
 * @return void
 */
 ...
 *
 * @param CakeText $file The file to update
