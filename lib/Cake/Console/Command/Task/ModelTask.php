 ...
 *
 * @param CakeText $className Name of class you want model to be.
 * @param CakeText $table Table name
 ...
 * @param CakeText $prompt Prompt to use for options list.
 ...
 *
 * @param CakeText $modelName Name of the model relations belong to.
 * @param CakeText $type Name of association you want to see. i.e. 'belongsTo'
 * @param CakeText $associations Collection of associations.
 * @return void
 */
 ...
 * @return CakeText Name of field that is a primary key.
 */
 ...
 *
 * @param CakeText $fieldName Name of field to be validated.
 * @param array $metaData metadata for field
 * @param CakeText $primaryKey The primary key field.
 ...
 *
 * @param CakeText|object $name Model name or object
 ...
 *
 * @param CakeText $className Model class name
 * @return CakeText
 */
 ...
 *
 * @param CakeText $useDbConfig Database configuration name
 * @return array
 */
 ...
 *
 * @param CakeText $modelName Name of the model you want a table for.
 * @param CakeText $useDbConfig Name of the database config you want to get tables from.
 * @return CakeText Table name
 */
 ...
 *
 * @param CakeText $useDbConfig Connection name to scan.
 ...
 *
 * @param CakeText $useDbConfig Database config name
 * @return CakeText The model name
 */
 ...
 *
 * @param CakeText $className Name of class to bake fixture for
 * @param CakeText $useTable Optional table name for fixture to use.
 * @return void
