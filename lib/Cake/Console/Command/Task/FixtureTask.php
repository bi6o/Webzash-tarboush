 ...
 *
 * @param CakeText $modelName Name of model you are dealing with.
 ...
 *
 * @param CakeText $model Name of model to bake.
 * @param CakeText $useTable Name of table to use.
 * @param array $importOptions Options for public $import
 * @return CakeText Baked fixture content
 */
 ...
 *
 * @param CakeText $model name of the model being generated
 * @param CakeText $otherVars Contents of the fixture file.
 * @return CakeText Content saved into fixture file.
 */
 ...
 *
 * @return CakeText Path for the fixtures
 */
 ...
 * @return CakeText fields definitions
 */
 ...
 * @return CakeText A string value of the $records array.
 */
 ...
 * to build a fixture.
 *
 * @param CakeText $modelName name of the model to take records from.
 * @param CakeText $useTable Name of table to use.
