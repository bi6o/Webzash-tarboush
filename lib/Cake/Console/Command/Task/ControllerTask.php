 ...
 *
 * @param CakeText $controllerName The name of the controller.
 * @param CakeText $useDynamicScaffold Whether or not to use dynamic scaffolds.
 ...
 *
 * @param CakeText $controllerName Controller name
 * @param CakeText $admin Admin route to use
 * @param bool $wannaUseSession Set to true to use sessions, false otherwise
 * @return CakeText Baked actions
 */
 ...
 *
 * @param CakeText $controllerName Controller name already pluralized and correctly cased.
 * @param CakeText $actions Actions to add, or set the whole controller to use $scaffold (set $actions to 'scaffold')
 * @param array $helpers Helpers to use in controller
 * @param array $components Components to use in controller
 * @return CakeText Baked controller
 */
 ...
 *
 * @param CakeText $className Controller class name
 * @return CakeText Baked test
 */
 ...
 *
 * @param CakeText $prompt A yes/no question to precede the list
 * @param CakeText $example A question for a comma separated list, with examples.
 ...
 *
 * @param CakeText $useDbConfig Connection name to get a controller name for.
 * @return CakeText Controller name
 */
