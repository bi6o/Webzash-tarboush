 ...
 *
 * @param CakeText $type The type of object to bake a test for.
 * @return CakeText|bool
 */
 ...
 *
 * @param CakeText $type Type of object to bake test case for ie. Model, Controller
 * @param CakeText $className the 'cake name' for the class ie. Posts for the PostsController
 * @return CakeText|bool
 */
 ...
 *
 * @return CakeText Users chosen type.
 */
 ...
 *
 * @param CakeText $objectType Type of object to list classes for i.e. Model, Controller.
 * @return CakeText Class name the user chose.
 */
 ...
 *
 * @param CakeText $type The Type of object you are generating tests for eg. controller
 * @return bool
 */
 ...
 *
 * @param CakeText $package The package of object you are generating tests for eg. controller
 * @param CakeText $class the Classname of the class the test is being generated for.
 * @return bool
 */
 ...
 * @param CakeText $type The Type of object you are generating tests for eg. controller
 * @param CakeText $class the Classname of the class the test is being generated for.
 * @return CakeText Real class name
 */
 ...
 *
 * @param CakeText $type The type of thing having a test generated.
 * @param CakeText $plugin The plugin name.
 * @return CakeText
 ...
 *
 * @param CakeText $type The type the class having a test
 *   generated for is in.
 ...
 *
 * @param CakeText $className Name of class to look at.
 ...
 *
 * @param CakeText $name Name of the Model class that a fixture might be required for.
 * @return void
 */
 ...
 *
 * @param CakeText $type The type of object tests are being generated for eg. controller.
 * @return bool
 */
 ...
 *
 * @param CakeText $type The Type of object you are generating tests for eg. controller
 * @param CakeText $fullClassName The Classname of the class the test is being generated for.
 * @param CakeText $plugin The plugin name.
 ...
 *
 * @param CakeText $type The Type of object you are generating tests for eg. controller
 * @param CakeText $realType The package name for the class.
 * @param CakeText $className The Classname of the class the test is being generated for.
 ...
 * @param CakeText $type The Type of object you are generating tests for eg. controller
 * @param CakeText $className the Classname of the class the test is being generated for.
 * @return CakeText filename the test should be created on.
 */
