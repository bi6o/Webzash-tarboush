 ...
 *
 * @param CakeText $category The category
 * @param CakeText $domain The domain
 * @param CakeText $msgid The message string
 ...
 * Parse tokens
 *
 * @param CakeText $functionName Function name that indicates translatable string (e.g: '__')
 ...
 *
 * @param CakeText $plugin Plugin name or `null` to process application models
 * @return void
 */
 ...
 *
 * @param CakeText $field the name of the field that is being processed
 * @param array $rules the set of validation rules for the field
 * @param CakeText $file the file name where this validation rule was found
 * @param CakeText $domain default domain to bind the validations to
 * @param CakeText $category the translation category
 * @return void
 */
 ...
 * @param CakeText $category The category
 * @param CakeText $domain The domain
 * @param CakeText $header The header content.
 * @param CakeText $sentence The sentence to store.
 * @return void
 */
 ...
 *
 * @return CakeText Translation template header
 */
 ...
 *
 * @param CakeText $string String to format
 * @return CakeText Formatted string
 */
 ...
 *
 * @param CakeText $file File where invalid marker resides
 * @param int $line Line number
 * @param CakeText $marker Marker found
