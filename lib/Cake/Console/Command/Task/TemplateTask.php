 ...
 * Runs the template
 *
 * @param CakeText $directory directory / type of thing you want
 * @param CakeText $filename template name
 * @param array $vars Additional vars to set to template scope.
 * @return CakeText contents of generated code template
 */
 ...
 *
 * @return CakeText returns the path to the selected theme.
 */
 ...
 *
 * @param CakeText $path The initial path to look for the file on. If it is not found fallbacks will be used.
 * @param CakeText $directory Subdirectory to look for ie. 'views', 'objects'
 * @param CakeText $filename lower_case_underscored filename you want.
 * @return CakeText filename will exit program if template is not found.
 */
