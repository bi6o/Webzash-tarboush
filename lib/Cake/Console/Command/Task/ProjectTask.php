 ...
 *
 * @param CakeText $path Project path
 * @param CakeText $skel Path to copy from
 * @param CakeText $skip array of directories to skip when copying
 * @return mixed
 */
 ...
 *
 * @param CakeText $dir Path to project
 * @return bool Success
 */
 ...
 *
 * @param CakeText $filename The filename to operate on.
 ...
 *
 * @param CakeText $name Name to use as admin routing
 * @return bool Success
 */
 ...
 *
 * @return CakeText Admin route to use
 */
