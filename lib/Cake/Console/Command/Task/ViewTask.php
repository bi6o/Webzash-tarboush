 ...
 *
 * @param CakeText $action Action to bake
 * @param CakeText $content Content to write
 * @return bool Success
 */
 ...
 *
 * @param CakeText $action name to generate content to
 * @param array $vars passed for use in templates
 * @return CakeText content from template
 */
 ...
 *
 * @param CakeText $action name
 * @return CakeText template name
 */
