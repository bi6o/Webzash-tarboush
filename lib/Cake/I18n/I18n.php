 ...
 *
 * @param CakeText $singular String to translate
 * @param CakeText $plural Plural string (if any)
 * @param CakeText $domain Domain The domain of the translation. Domains are often used by plugin translations.
 *    If null, the default domain will be used.
 * @param CakeText $category Category The integer value of the category to use.
 * @param int $count Count Count is used with $plural to choose the correct plural form.
 * @param CakeText $language Language to translate string to.
 *    If null it checks for language in session followed by Config.language configuration variable.
 * @return CakeText translated string.
 ...
 *
 * @param CakeText $domain Domain to bind
 * @return CakeText Domain binded
 */
 ...
 *
 * @param CakeText $filename Binary .mo file to load
 ...
 *
 * @param CakeText $filename Text .po file to load
 * @return mixed Array of translations on success or false on failure
 */
 ...
 *
 * @param CakeText $filename Locale definition filename
 ...
 *
 * @param CakeText $string Symbol to be parsed
 * @return CakeText parsed symbol
 */
 ...
 *
 * @param CakeText $format Format to be translated
 * @param CakeText $domain Domain where format is stored
