 ...
 *
 * @param CakeText $language Language (if null will use DEFAULT_LANGUAGE if defined)
 * @return mixed
 */
 ...
 *
 * @param CakeText $language Language (if null will use L10n::$default if defined)
 * @return mixed
 */
 ...
 *
 * @param CakeText|array $mixed 2/3 char string (language/locale), array of those strings, or null
 * @return CakeText|array|bool string language/locale, array of those values, whole map as an array,
 ...
 *
 * @param CakeText|array $language string requested language, array of requested languages, or null for whole catalog
