 ...
 *
 * @param CakeText $string String to convert.
 * @return array
 */
 ...
 *
 * @param CakeText $string value to encode
 * @param CakeText $charset charset to use for encoding. defaults to UTF-8
 * @param CakeText $newline Newline string.
 * @return CakeText
 */
 ...
 * @param CakeText $type Type 'lower' or 'upper'. Defaults to 'lower'.
 * @return array|null
 */
 ...
 *
 * @param CakeText $string Value to test.
 * @return bool
 */
