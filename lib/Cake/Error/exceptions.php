 ...
 * Constructor
 *
 * @param CakeText $message If no message is given 'Bad Request' will be the message
 ...
 * Constructor
 *
 * @param CakeText $message If no message is given 'Unauthorized' will be the message
 ...
 * Constructor
 *
 * @param CakeText $message If no message is given 'Forbidden' will be the message
 ...
 * Constructor
 *
 * @param CakeText $message If no message is given 'Not Found' will be the message
 ...
 * Constructor
 *
 * @param CakeText $message If no message is given 'Method Not Allowed' will be the message
 ...
 * Constructor
 *
 * @param CakeText $message If no message is given 'Internal Server Error' will be the message
 ...
 * when debug = 0.
 *
 * @param CakeText|array $message Either the string of the error message, or an array of attributes
 ...
 * Constructor
 *
 * @param CakeText|array $message The error message.
 ...
 * Constructor
 *
 * @param CakeText $message The error message.
 * @param int $code The error code.
 * @param CakeText $file The file the error occurred in.
