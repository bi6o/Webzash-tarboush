 ...
 * @return CakeText Absolute path for asset file
 */
 ...
 * @param CakeText $assetFile Path to the asset file in the file system
 * @param CakeText $ext The extension of the file to determine its mime type
 * @return void
 */
