 ...
 *
 * @param CakeText $routeClass to set as default
 ...
 *
 * @param CakeText $routeClass Route class name
 * @return CakeText
 * @throws RouterException
 */
 ...
 *
 * @param CakeText $route A string describing the template of the route
 ...
 *
 * @param CakeText|array $controller A controller name or array of controller names (i.e. "Posts" or "ListItems")
 ...
 *
 * @param CakeText $url URL to be parsed
 ...
 *
 * @param CakeText|array $url Cake-relative URL, like "/products/edit/92" or "/presidents/elect/4"
 ...
 *
 * @param CakeText $base the prefix for URLs generated containing the domain.
 ...
 * @return CakeText A generated URL for the array
 * @see Router::url()
 */
 ...
 *
 * @param CakeText|array $q Query string Either a string of already compiled query string arguments or
 ...
 *     the URL.
 * @return CakeText The string that is the reversed result of the array
 */
 ...
 *
 * @param array|CakeText $url URL to normalize Either an array or a string URL.
 * @return CakeText Normalized URL
 */
 ...
 *
 * @param CakeText $base Base URL
 * @param CakeText $plugin Plugin name
 * @return CakeText base URL with plugin name removed if present
 */
