 ...
 * Constructor.
 *
 * @param CakeText $base The base directory for the application. Writes `App.base` to Configure.
 */
 ...
 * @return CakeText|void if `$request['return']` is set then it returns response body, null otherwise
 ...
 * @return CakeText|bool Name of controller class name
 */
