 ...
 *
 * @param CakeText $template Template string with parameter placeholders
 ...
 *
 * @param CakeText $url The URL to attempt to parse.
 ...
 *
 * @param CakeText $args A string with the passed & named params. eg. /1/page:2
 * @param CakeText $context The current route context, which should contain controller/action keys.
 ...
 *
 * @param CakeText $val The value of the named parameter
 * @param array $rule The rule(s) to apply, can also be a match string
 * @param CakeText $context An array with additional context information (controller / action)
 * @return bool
 */
 ...
 * @return CakeText Composed route string.
 */
