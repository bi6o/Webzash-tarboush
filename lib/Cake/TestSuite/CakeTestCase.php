 ...
 *
 * @param CakeText $method Test method about to get executed.
 * @return void
 */
 ...
 *
 * @param CakeText $method Test method about that was executed.
 * @return void
 */
 ...
 * @param CakeText $message The message to display.
 * @return bool
 */
 ...
 *
 * @param CakeText $format format to be used.
 * @return CakeText
 */
 ...
 *
 * @param CakeText $expected The expected value.
 * @param CakeText $result The actual value.
 * @param CakeText $message The message to use for failure.
 * @return bool
 */
 ...
 * @param CakeText $expected The expected value.
 * @param CakeText $result The actual value.
 * @param CakeText $message message The message to use for failure.
 * @return bool
 */
 ...
 * Helpful for doing cross platform tests of blocks of text.
 *
 * @param CakeText $prefix The prefix to check for.
 * @param CakeText $string The string to search in.
 * @param CakeText $message The message to use for failure.
 * @return bool
 */
 ...
 * Helpful for doing cross platform tests of blocks of text.
 *
 * @param CakeText $prefix The prefix to not find.
 * @param CakeText $string The string to search.
 * @param CakeText $message The message to use for failure.
 * @return bool
 */
 ...
 * Helpful for doing cross platform tests of blocks of text.
 *
 * @param CakeText $suffix The suffix to find.
 * @param CakeText $string The string to search.
 * @param CakeText $message The message to use for failure.
 * @return bool
 */
 ...
 * Helpful for doing cross platform tests of blocks of text.
 *
 * @param CakeText $suffix The suffix to not find.
 * @param CakeText $string The string to search.
 * @param CakeText $message The message to use for failure.
 * @return bool
 */
 ...
 * Helpful for doing cross platform tests of blocks of text.
 *
 * @param CakeText $needle The string to search for.
 * @param CakeText $haystack The string to search through.
 * @param CakeText $message The message to display on failure.
 ...
 *
 * @param CakeText $string An HTML/XHTML/XML string
 * @param array $expected An array, see above
 * @param CakeText $fullDebug Whether or not more verbose output should be used.
 * @return bool
 */
 ...
 * @param CakeText $string The HTML string to check.
 * @return void
 */
 ...
 * @param CakeText $message the text to display if the assertion is not correct
 ...
 * @param CakeText $string the text to be matched
 * @param CakeText $message the text to display if the assertion is not correct
 * @deprecated 3.0.0 This is a compatiblity wrapper for 1.x. It will be removed in 3.0
 * @return void
 */
 ...
 *
 * @param CakeText $object
 * @param CakeText $type
 * @param CakeText $message
 * @deprecated 3.0.0 This is a compatiblity wrapper for 1.x. It will be removed in 3.0
 * @return void
 */
 ...
 * @param CakeText $message Message for skip
 * @return bool
 */
 ...
 *
 * @param CakeText $model The model to get a mock for.
