 ...
 *
 * @return CakeText Compiled HTML report.
 */
 ...
 *
 * @param CakeText $filename Name of the file having coverage generated
 ...
 * @return CakeText Possible test subject name.
 */
 ...
 *
 * @param CakeText $line The line content.
 * @param int $linenumber The line number
 * @param CakeText $class The classname to use.
 ...
 *
 * @param CakeText $filename The file name being covered
 * @param CakeText $percent The percentage covered
 * @return CakeText
 */
