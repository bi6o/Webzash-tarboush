 ...
 *
 * @param CakeText $filePath The file path to load
 * @param CakeText $params Additional parameters
 ...
 *
 * @param CakeText $params Path parameters
 * @return array
 */
 ...
 *
 * @param CakeText $directory The directory to scan for files.
 * @return array
 */
