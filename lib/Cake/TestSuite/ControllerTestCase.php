 ...
 *
 * @param CakeText $viewFile The view file
 * @return void
 */
 ...
 *
 * @param CakeText $name The name of the function
 ...
 *
 * @param CakeText $url The url to test
 ...
 *
 * @param CakeText $controller Controller name
