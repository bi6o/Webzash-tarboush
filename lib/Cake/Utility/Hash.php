 ...
 * @param CakeText|array $path The path being searched for. Either a dot
 ...
 * @param CakeText $path The path to extract.
 ...
 *
 * @param CakeText $token the token being splitted.
 ...
 *
 * @param CakeText $key The key in the array being searched.
 * @param CakeText $token The token being matched.
 * @return bool
 */
 ...
 * @param CakeText $selector The patterns to match.
 ...
 * @param CakeText $path The path to insert at.
 ...
 *
 * @param CakeText $op The operation to do.
 ...
 *
 * @param array $data The data to operate on
 * @param CakeText $path A path expression to use to remove.
 ...
 * @param CakeText $keyPath A dot-separated string.
 * @param CakeText $valuePath A dot-separated string.
 * @param CakeText $groupPath A dot-separated string.
 ...
 * @param CakeText $paths An array containing one or more Hash::extract()-style key paths
 ...
 * @param CakeText $path The path to check for.
 ...
 * @param CakeText $path The path to extract for mapping over.
 ...
 * @param CakeText $path The path to extract from $data.
 * @param callable $function The function to call on each extracted value.
 ...
 * @param CakeText $dir See directions above. Defaults to 'asc'.
 * @param CakeText $type See direction types above. Defaults to 'regular'.
 ...
 * @param CakeText $key The key for the data.
 * @return array
 */
