 ...
 *
 * @param CakeText $class A class name of the type of object to map to
 * @param CakeText $tmp A temporary class name used as $class if $class is an array
 ...
 * @param CakeText $class Class name
 ...
 *
 * @param CakeText $select Key in $list to return
 * @param array|CakeText $list can be an array or a comma-separated list.
 * @return CakeText the value of the array key or null if no match
 ...
 * @param CakeText $format Format string into which values will be inserted, see sprintf()
 ...
 *
 * @param CakeText $path An absolute XPath 2.0 path
 ...
 *
 * @param CakeText|array $conditions An array of condition strings or an XPath expression
 ...
 * @param CakeText|array $path As an array, or as a dot-separated string.
 * @return mixed An array of matched items or the content of a single selected item or null in any of these cases: $path or $data are null, no items found.
 ...
 * @param CakeText $path A dot-separated string.
 ...
 *
 * @param CakeText|array $data Data to check on
 * @param CakeText|array $path A dot-separated string.
 ...
 * @param CakeText $sep If $list is a string, it will be split into an array with $sep
 ...
 * @param CakeText|array $path1 As an array, or as a dot-separated string.
 * @param CakeText|array $path2 As an array, or as a dot-separated string.
 * @param CakeText $groupPath As an array, or as a dot-separated string.
 * @return array Combined array
 ...
 * @param CakeText $separator String used to separate array key elements in a path, defaults to '.'
 * @return array
 ...
 * @param CakeText $separator The delimiter used
 * @return array
 */
 ...
 * @param CakeText $path A Set-compatible path to the array value
 * @param CakeText $dir Direction of sorting - either ascending (ASC), or descending (DESC)
 ...
 * @param CakeText|array $path string or array of array keys
