 ...
 * @return CakeText Human readable size
 ...
 *
 * @param CakeText $size Size in human readable string like '5MB', '5M', '500B', '50kb' etc.
 ...
 * @return CakeText Percentage string
 ...
 * @return CakeText formatted number
 ...
 * @return CakeText formatted delta
 ...
 * @param CakeText $decimals Decimal position string.
 * @param CakeText $thousands Thousands separator string.
 * @return CakeText
 */
 ...
 *
 * @param float $value Value to format.
 * @param CakeText $currency Shortcut to default options. Valid values are
 *   'USD', 'EUR', 'GBP', otherwise set at least 'before' and 'after' options.
 * @param array $options Options list.
 * @return CakeText Number formatted as a currency.
 ...
 *
 * @param CakeText $formatName The format name to be used in the future.
 ...
 *
 * @param CakeText $currency Default currency string used by currency() if $currency argument is not provided
 * @return CakeText Currency
