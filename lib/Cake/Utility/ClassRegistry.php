 ...
 * }}}
 *
 * @param CakeText|array $class as a string or a single key => value array instance will be created,
 ...
 *
 * @param CakeText $key Key for the object in registry
 ...
 *
 * @param CakeText $key Key of object to remove from registry
 * @return void
 */
 ...
 *
 * @param CakeText $key Key to look for
 ...
 *
 * @param CakeText $key Key of object to look for
 ...
 *
 * @param CakeText $type Type of object. If this parameter is omitted, defaults to "Model"
 ...
 *
 * @param CakeText $alias Alias to check.
 ...
 *
 * @param CakeText $key Key to include in map
 * @param CakeText $name Key that is being mapped
 * @return void
 */
 ...
 *
 * @param CakeText $key Key to find in map
 * @return CakeText Mapped value
 */
