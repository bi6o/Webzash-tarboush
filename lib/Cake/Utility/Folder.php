 ...
 * Constructor.
 *
 * @param CakeText $path Path to folder
 * @param bool $create Create folder if not found
 * @param CakeText|bool $mode Mode (CHMOD) to apply to created folder, false to ignore
 ...
 *
 * @param CakeText $path Path to the directory to change to
 * @return CakeText The new path. Returns false on failure
 ...
 *
 * @param CakeText $regexpPattern Preg_match pattern (Defaults to: .*)
 ...
 *
 * @param CakeText $pattern Preg_match pattern (Defaults to: .*)
 * @param bool $sort Whether results should be sorted.
 ...
 *
 * @param CakeText $pattern Pattern to match against
 * @param bool $sort Whether results should be sorted.
 * @return array Files matching pattern
 */
 ...
 *
 * @param CakeText $path Path to check
 ...
 *
 * @param CakeText $path Path to check
 * @return CakeText Set of slashes ("\\" or "/")
 ...
 *
 * @param CakeText $path Path to check
 * @return CakeText Path with ending slash
 ...
 *
 * @param CakeText $path Path
 * @param CakeText|array $element Element to add at end of path
 * @return CakeText Combined path
 ...
 *
 * @param CakeText $path The path to check.
 * @return bool
 ...
 *
 * @param CakeText $path The path to check that the current pwd() resides with in.
 ...
 *
 * @param CakeText $path The path to chmod.
 ...
 *
 * @param CakeText $path the directory path to build the tree from
 * @param array|bool $exceptions Either an array of files/folder to exclude
 *   or boolean true to not grab dot files/folders
 * @param CakeText $type either 'file' or 'dir'. null returns both files and directories
 ...
 *
 * @param CakeText $pathname The directory structure to create. Either an absolute or relative
 ...
 *
 * @param CakeText $path Path of directory to delete
 * @return bool Success
 ...
 *
 * @param array|CakeText $options Either an array of options (see above) or a string of the destination directory.
 * @return bool Success.
 ...
 *
 * @param CakeText $path Path to resolve
 * @return CakeText The resolved path
