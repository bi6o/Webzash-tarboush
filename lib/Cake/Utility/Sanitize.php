 ...
 *
 * @param CakeText $string String to sanitize
 * @param array $allowed An array of additional characters that are not to be removed.
 * @return CakeText Sanitized string
 */
 ...
 *
 * @param CakeText $string String to sanitize
 * @param CakeText $connection Database connection being used
 * @return CakeText SQL safe string
 */
 ...
 *
 * @param CakeText $string String from where to strip tags
 ...
 *
 * @param CakeText $str String to sanitize
 * @return CakeText whitespace sanitized string
 */
 ...
 *
 * @param CakeText $str String to sanitize
 * @return CakeText Sting with images stripped.
 */
 ...
 *
 * @param CakeText $str String to sanitize
 * @return CakeText String with <link>, <img>, <script>, <style> elements and html comments removed.
 */
 ...
 *
 * @param CakeText|array $data Data to sanitize
 * @param CakeText|array $options If string, DB connection being used, otherwise set of options
