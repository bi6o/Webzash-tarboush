 ...
 *
 * @param CakeText $authKey Authorization hash
 * @return bool Success
 */
 ...
 * }}}
 *
 * @param CakeText $string String to hash
 * @param CakeText $type Method to use (sha1/sha256/md5/blowfish)
 ...
 * Security::hash().
 *
 * @param CakeText $hash Method to use (sha1/sha256/md5/blowfish)
 * @return void
 * @see Security::hash()
 */
 ...
 * encryption.
 *
 * @param CakeText $text Encrypted string to decrypt, normal string to encrypt
 * @param CakeText $key Key to use
 * @return CakeText Encrypted/Decrypted string
 ...
 *
 * @param CakeText $text Encrypted string to decrypt, normal string to encrypt
 * @param CakeText $key Key to use as the encryption key for encrypted data.
 * @param CakeText $operation Operation to perform, encrypt or decrypt
 * @return CakeText Encrypted/Decrypted string
 */
 ...
 * @return CakeText The generated salt
 */
 ...
 *
 * @param CakeText $password The string to be encrypted.
 * @param mixed $salt false to generate a new salt or an existing salt.
 * @return CakeText The hashed string or an empty string on error.
 */
 ...
 *
 * @param CakeText $plain The value to encrypt.
 * @param CakeText $key The 256 bit/32 byte key to use as a cipher key.
 * @param CakeText $hmacSalt The salt to use for the HMAC process. Leave null to use Security.salt.
 * @return CakeText Encrypted data.
 ...
 *
 * @param CakeText $key Key to check.
 * @param CakeText $method The method the key is being checked for.
 * @return void
 ...
 *
 * @param CakeText $cipher The ciphertext to decrypt.
 * @param CakeText $key The 256 bit/32 byte key to use as a cipher key.
 * @param CakeText $hmacSalt The salt to use for the HMAC process. Leave null to use Security.salt.
 * @return CakeText Decrypted data. Any trailing null bytes will be removed.
 * @throws CakeException On invalid data or key.
 */
