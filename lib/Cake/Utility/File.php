 ...
 * Constructor
 *
 * @param CakeText $path Path to file
 ...
 *
 * @param CakeText $mode A valid 'fopen' mode string (r|w|a ...)
 ...
 *
 * @param CakeText $bytes where to start
 * @param CakeText $mode A `fread` compatible mode.
 * @param bool $force If true then the file will be re-opened even if its already opened, otherwise it won't
 ...
 *
 * @param CakeText $data Data to prepare for writing.
 * @param bool $forceWindows If true forces usage Windows newline string.
 * @return CakeText The with converted line endings.
 ...
 *
 * @param CakeText $data Data to write to this File.
 * @param CakeText $mode Mode of writing. {@link http://php.net/fwrite See fwrite()}.
 * @param CakeText $force Force the file to open
 * @return bool Success
 ...
 *
 * @param CakeText $data Data to write
 * @param CakeText $force Force the file to open
 * @return bool Success
 ...
 *
 * @return CakeText The file extension
 ...
 *
 * @return CakeText The file name without extension.
 ...
 *
 * @param CakeText $name The name of the file to make safe if different from $this->name
 * @param CakeText $ext The name of the extension to make safe if different from $this->ext
 * @return CakeText ext The extension of the file
 ...
 * @return CakeText|false md5 Checksum {@link http://php.net/md5_file See md5_file()}, or false in case of an error
 ...
 *
 * @return CakeText Full path to the file
 ...
 *
 * @return CakeText|false Permissions for the file, or false in case of an error
 ...
 *
 * @param CakeText $dest Destination for the copy
 ...
 *
 * @return false|CakeText The mimetype of the file, or false if reading fails.
 */
 ...
 *
 * @param CakeText|array $search Text(s) to search for.
 * @param CakeText|array $replace Text(s) to replace with.
 * @return bool Success
 */
