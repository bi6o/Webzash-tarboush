 ...
 *
 * @param CakeText|array $check Value to check
 * @return bool Success
 */
 ...
 *
 * @param CakeText $check Value to check for length
 ...
 *
 * @param CakeText|array $check credit card number to validate
 * @param CakeText|array $type 'all' may be passed as a sting, defaults to fast which checks format of most major credit cards
 *    if an array is used only the values of the array are checked.
 *    Example: array('amex', 'bankcard', 'maestro')
 * @param bool $deep set to true this will check the Luhn algorithm of the credit card.
 * @param CakeText $regex A custom regex can also be passed, this will be used instead of the defined regex values
 * @return bool Success
 * @see Validation::luhn()
 */
 ...
 *
 * @param CakeText|array $check1 if string is passed for a string must also be passed for $check2
 *    used as an array it must be passed as array('check1' => value, 'operator' => 'value', 'check2' -> value)
 * @param CakeText $operator Can be either a word or operand
 ...
 *
 * @param CakeText|array $check When used as a string, $regex must also be a valid regular expression.
 *    As and array: array('check' => value, 'regex' => 'valid regular expression')
 * @param CakeText $regex If $check is passed as a string, $regex must also be set to valid regular expression
 * @return bool Success
 */
 ...
 *
 * @param CakeText $check a valid date string
 * @param CakeText|array $format Use a string or an array of the keys above.
 *    Arrays should be passed as array('dmy', 'mdy', etc)
 * @param CakeText $regex If a custom regular expression is used this is the only validation that will occur.
 * @return bool Success
 */
 ...
 *
 * @param CakeText $check Value to check
 * @param CakeText|array $dateFormat Format of the date part. See Validation::date for more information.
 * @param CakeText $regex Regex for the date part. If a custom regular expression is used this is the only validation that will occur.
 ...
 *
 * @param CakeText $check a valid time string
 * @return bool Success
 */
 ...
 *
 * @param CakeText $check a valid boolean
 * @return bool Success
 */
 ...
 * @param CakeText $regex Regex to use (if none it will use built in regex)
 * @return bool Success
 */
 ...
 *
 * @param CakeText $check The string to test.
 * @param CakeText $type The IP Protocol version to validate against
 * @return bool Success
 */
 ...
 *
 * @param CakeText $check Value to check
 * @param CakeText $symbolPosition Where symbol is located (left/right)
 * @return bool Success
 */
 ...
 *
 * @param CakeText|array $check Value to check (string or array)
 * @param CakeText $regex Regular expression to use
 * @param CakeText $country Country code (defaults to 'all')
 * @return bool Success
 */
 ...
 * @param CakeText|array $check Value to check
 * @param CakeText $regex Regular expression to use
 * @param CakeText $country Country to use for formatting
 * @return bool Success
 */
 ...
 * @param CakeText|array $check Value to check
 * @param CakeText $regex Regular expression to use
 * @param CakeText $country Country
 * @return bool Success
 */
 ...
 *
 * @param CakeText|array $check value that will be validated in user-defined methods.
 * @param object $object class that holds validation method
 * @param CakeText $method class method name for validation to run
 ...
 * `NlValidation`.
 *
 * @param CakeText $method The method to call on the other class.
 * @param mixed $check The value to check or an array of parameters for the method to be called.
 * @param CakeText $classPrefix The prefix for the class to do the validation.
 ...
 *
 * @param CakeText $check Value to check against the $regex expression
 * @param CakeText $regex Regular expression
 ...
 *
 * @param CakeText|array $check Value to check.
 * @param array|CakeText $mimeTypes Array of mime types or regex pattern to check.
 * @return bool Success
 ...
 *
 * @param CakeText|array $check Value to check.
 * @param CakeText $operator See `Validation::comparison()`.
 * @param int|CakeText $size Size in bytes or human readable string like '5MB'.
 * @return bool Success
 */
