 ...
 *
 * @param CakeText $data The data to tokenize.
 * @param CakeText $separator The token to split the data on.
 * @param CakeText $leftBound The left boundary to ignore separators in.
 * @param CakeText $rightBound The right boundary to ignore separators in.
 ...
 *
 * @param CakeText $str A string containing variable placeholders
 ...
 * by String::insert().
 *
 * @param CakeText $str String to clean.
 ...
 *
 * @param CakeText $text The text to format.
 * @param array|int $options Array of options to use, or an integer to wrap the text to.
 * @return CakeText Formatted text.
 */
 ...
 * @param CakeText $break The line is broken using the optional break parameter. Defaults to '\n'.
 ...
 *
 * @param CakeText $text Text to search the phrase in.
 * @param CakeText|array $phrase The phrase or phrases that will be searched.
 * @param array $options An array of html attributes and options.
 * @return CakeText The highlighted text
 ...
 *
 * @param CakeText $text Text
 * @return CakeText The text without links
 ...
 *
 * @param CakeText $text String to truncate.
 * @param int $length Length of returned string, including ellipsis.
 * @param array $options An array of options.
 * @return CakeText Trimmed string.
 */
 ...
 *
 * @param CakeText $text String to search the phrase in
 * @param CakeText $phrase Phrase that will be searched for
 * @param int $radius The amount of characters that will be returned on each side of the founded phrase
 * @param CakeText $ellipsis Ending that will be appended
 * @return CakeText Modified string
 ...
 * @param CakeText $and The word used to join the last and second last items together with. Defaults to 'and'
 * @param CakeText $separator The separator used to join all the other items together. Defaults to ', '
 * @return CakeText The glued together string.
