 ...
 *
 * @param CakeText|array $input XML string, a path to a file, a URL or an array
 ...
 *
 * @param CakeText $input The input to load.
 ...
 * @param CakeText $format Either 'attribute' or 'tags'. This determines where nested keys go.
 * @return void
 * @throws XmlException
 */
 ...
 * @param CakeText $ns Namespace of current child
