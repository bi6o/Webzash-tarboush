 ...
 * a loaded object.
 *
 * @param CakeText $name Name of object to load.
 ...
 *    Defaults to false.
 *
 * @param CakeText|CakeEvent $callback Method to fire on all the objects. Its assumed all the objects implement
 ...
 *
 * @param CakeText $name Name of property to read
 * @return mixed
 */
 ...
 *
 * @param CakeText $name Name of object being checked.
 * @return bool
 */
 ...
 *
 * @param CakeText|array $name CamelCased name of the object(s) to enable (string or array)
 ...
 * callable as normal.
 *
 * @param CakeText|array $name CamelCased name of the objects(s) to disable (string or array)
 * @return void
 */
 ...
 *
 * @param CakeText $name Optional. The name of the object to check the status of. If omitted,
 ...
 *
 * @param CakeText $name Name of the object to delete.
 * @return void
 */
 ...
 *
 * @param CakeText $name Name of the object
