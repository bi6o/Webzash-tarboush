 ...
 *
 * @param CakeText $name Variable name
 ...
 *
 * @param CakeText $format Format with specifiers for strftime function.
 *    Accepts the special specifier %S which mimics the modifier S for date()
 * @param CakeText $time UNIX timestamp
 * @return CakeText windows safe and date() function compatible format for strftime
 ...
 * @return CakeText converted element
 */
 ...
 *
 * @param CakeText $serverTime UNIX timestamp
 * @param CakeText|DateTimeZone $timezone User's timezone string or DateTimeZone object
 ...
 *
 * @param CakeText|DateTimeZone $timezone Timezone string or DateTimeZone object
 ...
 *
 * @param int|CakeText|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime object
 * @param CakeText|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return CakeText Parsed timestamp
 ...
 * @param int|CakeText|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime object
 * @param CakeText|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @param CakeText $format The format to use. If null, `CakeTime::$niceFormat` is used
 * @return CakeText Formatted date string
 ...
 * @param int|CakeText|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime object
 * @param CakeText|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return CakeText Described, relative date string
 ...
 *
 * @param int|CakeText|DateTime $begin UNIX timestamp, strtotime() valid string or DateTime object
 * @param int|CakeText|DateTime $end UNIX timestamp, strtotime() valid string or DateTime object
 * @param CakeText $fieldName Name of database field to compare with
 * @param CakeText|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return CakeText Partial SQL string.
 ...
 * @param int|CakeText|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime object
 * @param CakeText|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @param CakeText $format date format string
 ...
 *
 * @param CakeText $dateString Datetime string or Unix timestamp
 * @param CakeText|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return CakeText Formatted date string
 ...
 *
 * @param int|CakeText|DateTime $dateTime Datetime UNIX timestamp, strtotime() valid string or DateTime object
 * @param array $options Default format if timestamp is used in $dateString
 * @return CakeText Relative time string.
 ...
 *
 * @param CakeText|int $timeInterval the numeric value with space then time type.
 ...
 * }}}
 *
 * @param int|CakeText|DateTime $date UNIX timestamp, strtotime() valid string or DateTime object (or a date format string)
 * @param int|CakeText|DateTime $format date format string (or UNIX timestamp, strtotime() valid string or DateTime object)
 * @param bool|CakeText $default if an invalid date is passed it will output supplied default value. Pass false if you want raw conversion value
 * @param CakeText|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return CakeText Formatted date string
 ...
 *
 * @param int|CakeText|DateTime $date UNIX timestamp, strtotime() valid string or DateTime object
 * @param CakeText $format strftime format string.
 * @param bool|CakeText $default if an invalid date is passed it will output supplied default value. Pass false if you want raw conversion value
 * @param CakeText|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return CakeText Formatted and translated date string
 ...
 *
 * @param int|CakeText $filter A regex to filter identifier
 * 	Or one of DateTimeZone class constants (PHP 5.3 and above)
 * @param CakeText $country A two-letter ISO 3166-1 compatible country code.
 ...
 *
 * @param CakeText $format Format string.
 * @param int $date Timestamp to format.
 * @return CakeText formatted string with correct encoding.
 */
