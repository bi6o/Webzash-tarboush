 ...
 *
 * @param CakeText $type Inflection type
 * @param CakeText $key Original value
 * @param CakeText $value Inflected value
 * @return CakeText Inflected value, from cache
 */
 ...
 * }}}
 *
 * @param CakeText $type The type of inflection, either 'plural', 'singular' or 'transliteration'
 ...
 *
 * @param CakeText $word Word in singular
 * @return CakeText Word in plural
 ...
 *
 * @param CakeText $word Word in plural
 * @return CakeText Word in singular
 ...
 *
 * @param CakeText $lowerCaseAndUnderscoredWord Word to camelize
 * @return CakeText Camelized word. LikeThis.
 ...
 *
 * @param CakeText $camelCasedWord Camel-cased word to be "underscorized"
 * @return CakeText Underscore-syntaxed version of the $camelCasedWord
 ...
 *
 * @param CakeText $lowerCaseAndUnderscoredWord String to be made more readable
 * @return CakeText Human-readable string
 ...
 *
 * @param CakeText $className Name of class to get database table name for
 * @return CakeText Name of the database table for given class
 ...
 *
 * @param CakeText $tableName Name of database table to get class name for
 * @return CakeText Class name
 ...
 * @return CakeText in variable form
 ...
 *
 * @param CakeText $string the string you want to slug
 * @param CakeText $replacement will replace keys in map
 * @return CakeText
