 ...
 *
 * @param CakeText $name Name of template file in the/app/View/Elements/ folder,
 ...
 * @return CakeText Rendered Element
 */
 ...
 *
 * @param CakeText $view Name of view file to use
 * @param CakeText $layout Layout to use.
 * @return CakeText|null Rendered content or null if content already rendered and returned earlier.
 ...
 *
 * @param CakeText $content Content to render in a view, wrapped by the surrounding layout.
 * @param CakeText $layout Layout name
 ...
 *
 * @param CakeText $filename the cache file to include
 * @param CakeText $timeStart the page render start time
 ...
 *
 * @param CakeText $var The view var you want the contents of.
 ...
 *
 * @param CakeText $name The name of the block to capture for.
 * @return void
 * @see ViewBlock::start()
 */
 ...
 *
 * @param CakeText $name Name of the block
 ...
 *
 * @param CakeText $name Name of the block
 * @param CakeText $default Default text
 * @return CakeText default The block content or $default if the block does not exist.
 * @see ViewBlock::get()
 */
 ...
 *
 * @param CakeText $name The view or element to 'extend' the current one with.
 * @return void
 ...
 *
 * @param CakeText $name Either the key name for the script, or the script content. Name can be used to
 *   update/replace a script element.
 * @param CakeText $content The content of the script being added, optional.
 * @return void
 ...
 *
 * @param CakeText $object Type of object, i.e. 'form' or 'link'
 * @param CakeText $url The object's target URL
 * @return CakeText
 */
 ...
 *
 * @param CakeText|array $one A string or an array of data.
 * @param CakeText|array $two Value in case $one is a string (which then works as the key).
 ...
 *
 * @param CakeText $name Name of the attribute to get.
 * @return mixed
 */
 ...
 *
 * @param CakeText $name Name of the attribute to set.
 ...
 *
 * @param CakeText $name Name of the attribute to check.
 * @return bool
 */
 ...
 *
 * @param CakeText $viewFile Filename of the view
 * @param array $data Data to include in rendered view. If empty the current View::$viewVars will be used.
 * @return CakeText Rendered output
 ...
 *
 * @param CakeText $helperName Name of the helper to load.
 ...
 *
 * @param CakeText $name Controller action to find template filename for
 * @return CakeText Template filename
 ...
 *
 * @param CakeText $name The name you want to plugin split.
 ...
 *
 * @param CakeText $name The name of the layout to find.
 * @return CakeText Filename for layout file (.ctp).
 ...
 *
 * @param CakeText $name The name of the element to find.
 ...
 *
 * @param CakeText $plugin Optional plugin name to scan for view files.
 ...
 *
 * @param CakeText $name Element name
 * @param CakeText $data Data
 * @param array $options Element options
 * @return CakeText|null
 */
 ...
 *
 * @param CakeText $file Element file path
