 ...
 * @param CakeText $mode If ViewBlock::APPEND content will be appended to existing content.
 ...
 *
 * @param CakeText $name Name of the block
 * @param CakeText $value The content for the block.
 * @return void
 ...
 *
 * @param CakeText $name Name of the block
 * @param CakeText $default Default string
 * @return CakeText The block content or $default if the block does not exist.
 */
