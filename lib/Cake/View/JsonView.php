 ...
 *     JSONP callback name.
 *
 * @param CakeText $view The view being rendered.
 * @param CakeText $layout The layout being rendered.
 * @return CakeText The rendered view.
 */
 ...
 * @return CakeText The serialized data
 */
