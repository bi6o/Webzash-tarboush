 ...
 *
 * @param CakeText $method Method to invoke
 ...
 *
 * @param CakeText $name Name of the property being accessed.
 ...
 *
 * @param CakeText|array $url Either a relative string url like `/products/view/23` or
 *    an array of URL parameters. Using an array for URLs will allow you to leverage
 *    the reverse routing features of CakePHP.
 * @param bool $full If true, the full base URL will be prepended to the result
 * @return CakeText Full translated URL with base path.
 ...
 *
 * @param CakeText $file The file to create a webroot path to.
 * @return CakeText Web accessible path to file.
 */
 ...
 *
 * @param CakeText|array $path Path string or URL array
 * @param array $options Options array. Possible keys:
 *   `fullBase` Return full URL with domain name
 *   `pathPrefix` Path prefix for relative URLs
 *   `ext` Asset extension to append
 *   `plugin` False value will prevent parsing path as a plugin
 * @return CakeText Generated URL
 */
 ...
 *
 * @param CakeText $url The URL to encode.
 * @return CakeText The URL encoded for both URL & HTML contexts.
 */
 ...
 *
 * @param CakeText $path The file path to timestamp, the path must be inside WWW_ROOT
 * @return CakeText Path with a timestamp added, or not.
 */
 ...
 *
 * @param CakeText|array $output Either an array of strings to clean or a single string to clean.
 * @return CakeText|array|null Cleaned content for output
 * @deprecated 3.0.0 This method will be removed in 3.0
 */
 ...
 * @param CakeText $insertBefore String to be inserted before options.
 * @param CakeText $insertAfter String to be inserted after options.
 * @return CakeText Composed attributes.
 ...
 *
 * @param CakeText $key The name of the attribute to create
 * @param CakeText $value The value of the attribute to create.
 * @param bool $escape Define if the value must be escaped
 * @return CakeText The composed attribute.
 * @deprecated 3.0.0 This method will be moved to HtmlHelper in 3.0
 */
 ...
 *
 * @param CakeText $message Message to be displayed
 * @param CakeText $okCode Code to be executed after user chose 'OK'
 * @param CakeText $cancelCode Code to be executed after user chose 'Cancel'
 * @param array $options Array of options
 * @return CakeText onclick JS code
 */
 ...
 *
 * @param CakeText $entity A field name, like "ModelName.fieldName" or "ModelName.ID.fieldName"
 ...
 *
 * @param array|CakeText $options Either an array of html attributes to add $id into, or a string
 *   with a view entity path to get a domId for.
 * @param CakeText $id The name of the 'id' attribute.
 ...
 *
 * @param array|CakeText $options If an array, should be an array of attributes that $key needs to be added to.
 *   If a string or null, will be used as the View entity.
 * @param CakeText $field Field name.
 * @param CakeText $key The name of the attribute to be set, defaults to 'name'
 ...
 *   If a string or null, will be used as the View entity.
 * @param CakeText $field Field name.
 * @param CakeText $key The name of the attribute to be set, defaults to 'value'
 * @return mixed If an array was given for $options, an array with $key set will be returned.
 *   If a string was supplied a string will be returned.
 */
 ...
 *
 * @param CakeText $field The field name to initialize.
 ...
 * @param CakeText $class The class name being added.
 * @param CakeText $key the key to use for class.
 ...
 *
 * @param CakeText $str String to be output.
 * @return CakeText
 ...
 *
 * @param CakeText $viewFile The view file that is going to be rendered
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param CakeText $viewFile The view file that was rendered.
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param CakeText $layoutFile The layout about to be rendered.
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param CakeText $layoutFile The layout file that was rendered.
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param CakeText $viewFile The file about to be rendered.
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param CakeText $viewFile The file just be rendered.
 * @param CakeText $content The content that was rendered.
 * @return void
 */
 ...
 *
 * @param CakeText|array $data Data array or model name.
 * @param CakeText $key Field name.
 * @return array
 */
