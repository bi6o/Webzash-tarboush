 ...
 * @param CakeText $output The output for the file.
 * @return CakeText Updated content.
 */
 ...
 *
 * @param CakeText $layoutFile Layout file name.
 * @return void
 */
 ...
 *
 * @param CakeText $file The filename to process.
 * @param CakeText $out The output for the file.
 * @return CakeText Updated content.
 */
 ...
 *
 * @param CakeText $file File to cache
 * @param CakeText $out output to cache
 * @return CakeText view output
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/cache.html
 ...
 *
 * @param CakeText $file The filename that needs to be parsed.
 * @param CakeText $cache The cached content
 * @return void
 */
 ...
 *
 * @return CakeText The content with cake:nocache tags replaced.
 */
 ...
 *
 * @param CakeText $content String to remove tags from.
 * @return CakeText String with tags removed.
 */
 ...
 *
 * @param CakeText $cache Output to replace content in.
 * @return CakeText with all replacements made to <!--nocache--><!--nocache-->
 */
 ...
 *
 * @param CakeText $content view content to write to a cache file.
 * @param CakeText $timestamp Duration to set for cache file.
