 ...
 * @param CakeText $value Value of the attribute to set.
 * @return void
 */
 ...
 *
 * @param CakeText $method Method to call.
 ...
 *
 * @param int|CakeText|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime objectp
 * @param CakeText|DateTimeZone $timezone User's timezone string or DateTimeZone object
 ...
 *
 * @param int|CakeText|DateTime $dateTime UNIX timestamp, strtotime() valid string or DateTime object
 ...
 *
 * @param int|CakeText|DateTime $string UNIX timestamp, strtotime() valid string or DateTime object
 * @return int UNIX timestamp
 * @see CakeTime::gmt()
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 * }}}
 *
 * @param int|CakeText|DateTime $format date format string (or a UNIX timestamp, strtotime() valid string or DateTime object)
