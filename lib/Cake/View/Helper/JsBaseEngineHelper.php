 ...
 *
 * @param CakeText $message Message you want to alter.
 * @return CakeText completed alert()
 */
 ...
 *
 * @param CakeText|array $url URL
 * @return CakeText completed redirect in javascript
 */
 ...
 *
 * @param CakeText $message Message you want confirmed.
 * @return CakeText completed confirm()
 */
 ...
 * function scope.
 *
 * @param CakeText $message Message to use in the confirm dialog.
 * @return CakeText completed confirm with return script
 */
 ...
 *
 * @param CakeText $message Message you want to prompt.
 * @param CakeText $default Default message
 * @return CakeText completed prompt()
 */
 ...
 * @return CakeText A JSON code block
 */
 ...
 * @param CakeText $key Key name.
 * @return CakeText a JavaScript-safe/JSON representation of $val
 */
 ...
 * - '"' => '\"'
 *
 * @param CakeText $string String that needs to get escaped.
 * @return CakeText Escaped string.
 */
 ...
 *
 * @param CakeText $string The string that needs to be utf8->hex encoded
 * @return void
 */
 ...
 *
 * @param CakeText $selector The selector that is targeted
 ...
 *
 * @param CakeText $type Type of event to bind to the current dom id
 * @param CakeText $callback The JavaScript function you wish to trigger or the function literal
 * @param array $options Options for the event.
 * @return CakeText completed event handler
 */
 ...
 *
 * @param CakeText $functionBody The code to run on domReady
 * @return CakeText completed domReady method
 */
 ...
 *
 * @param CakeText $callback The function body you wish to apply during the iteration.
 * @return CakeText completed iteration
 */
 ...
 *   the speed option.
 *
 * @param CakeText $name The name of the effect to trigger.
 * @param array $options Array of options for the effect.
 * @return CakeText completed string with effect.
 */
 ...
 *
 * @param CakeText|array $url Array or String URL to target with the request.
 * @param array $options Array of options. See above for cross library supported options
 * @return CakeText XHR request.
 */
 ...
 * @return CakeText Completed drag script
 */
 ...
 * @return CakeText Completed drop script
 */
 ...
 * @return CakeText Completed sortable script.
 */
 ...
 * @return CakeText Completed slider script
 */
 ...
 * @return CakeText completed form serialization script
 */
 ...
 * @return CakeText Parsed JSON options without enclosing { }.
 */
 ...
 *
 * @param CakeText $method Name of method whose options are being worked with.
 ...
 * _callbackArgs array.
 *
 * @param CakeText $method Name of the method you are preparing callbacks for.
 ...
 *
 * @param CakeText $method Name of method processing options for.
 * @param array $options Array of options to process.
 * @return CakeText Parsed options string.
 */
 ...
 * @return CakeText Querystring fragment
 */
