 ...
 *
 * @param CakeText $viewFile View file name.
 * @return void
 */
 ...
 *
 * @param CakeText $model Optional model name. Uses the default if none is specified.
 ...
 *
 * @param CakeText $key Key of the paginator params array to retrieve.
 * @param CakeText $model Optional model name. Uses the default if none is specified.
 ...
 *
 * @param array|CakeText $options Default options for pagination links. If a string is supplied - it
 ...
 *
 * @param CakeText $model Optional model name. Uses the default if none is specified.
 * @return CakeText The current page number of the recordset.
 ...
 * @return CakeText|null The name of the key by which the recordset is being sorted, or
 ...
 * @param CakeText $model Optional model name. Uses the default if none is specified.
 * @param array $options Options for pagination links. See #options for list of keys.
 * @return CakeText The direction by which the recordset is being sorted, or
 *  null if the results are not currently sorted.
 ...
 *
 * @param CakeText $title Title for the link. Defaults to '<< Previous'.
 * @param array $options Options for pagination link. See #options for list of keys.
 * @param CakeText $disabledTitle Title when the link is disabled.
 * @param array $disabledOptions Options for the disabled pagination link. See #options for list of keys.
 * @return CakeText A "previous" link or $disabledTitle text if the link is disabled.
 ...
 *
 * @param CakeText $title Title for the link. Defaults to 'Next >>'.
 ...
 * @return CakeText A "next" link or $disabledTitle text if the link is disabled.
 ...
 *
 * @param CakeText $key The name of the key that the recordset should be sorted.
 * @param CakeText $title Title for the link. If $title is null $key will be used
 *		for the title and will be generated by inflection.
 * @param array $options Options for sorting link. See above for list of keys.
 * @return CakeText A link sorting default by 'asc'. If the resultset is sorted 'asc' by the specified
 ...
 * - `model` The model to use, defaults to PaginatorHelper::defaultModel()
 *
 * @param CakeText $title Title for the link.
 * @param CakeText|array $url URL for the action. See Router::url()
 * @param array $options Options for the link. See #options for list of keys.
 * @return CakeText A link with pagination parameters.
 ...
 * @param CakeText $model Which model to paginate on
 ...
 *
 * @param CakeText $which Link type: 'Prev', 'Next'.
 * @param CakeText $title Link title.
 * @param array $options Options list.
 * @param CakeText $disabledTitle Disabled link title.
 ...
 *
 * @param CakeText $model Model name to get parameters for.
 ...
 *
 * @return CakeText|null Model name or null if the pagination isn't initialized.
 ...
 * @return CakeText Counter string.
 ...
 * @return CakeText|bool numbers string.
 ...
 *
 * @param CakeText|int $first if string use as label for the link. If numeric, the number of page links
 ...
 * - `ellipsis` Content for ellipsis, defaults to '...'
 *
 * @param CakeText|int $last if string use as label for the link, if numeric print page numbers
