 ...
 * @return CakeText The text with links
 ...
 * @return CakeText Replaced values.
 */
 ...
 *
 * @param CakeText $text The text to operate on.
 * @param array $htmlOptions The options for the generated links.
 * @return CakeText The text with links inserted.
 */
 ...
 * @param CakeText $phrase The phrase that will be searched
 ...
 *
 * @param CakeText $text Text
 * @return CakeText The text with proper <p> and <br /> tags
 ...
 * @param CakeText $ending Ending that will be appended
