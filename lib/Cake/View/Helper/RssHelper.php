 ...
 * @param CakeText $content Tag content.
 * @return CakeText An RSS document
 ...
 * @param CakeText $content Content (`<item />`'s belonging to this channel
 * @return CakeText An RSS `<channel />`
 ...
 * @param CakeText|array $callback A string function name, or array containing an object
 *     and a string method name
 * @return CakeText A set of RSS `<item />` elements
 ...
 * @return CakeText An RSS `<item />` element
 ...
 *
 * @param int|CakeText|DateTime $time UNIX timestamp or valid time string or DateTime object.
 * @return CakeText An RSS-formatted timestamp
 ...
 *
 * @param CakeText $name The name of the XML element
 * @param array $attrib The attributes of the XML element
 * @param CakeText|array $content XML element content
