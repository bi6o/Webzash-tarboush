 ...
 *
 * @param CakeText $name Text for link
 * @param CakeText $link URL for link (if empty it won't be a link)
 * @param CakeText|array $options Link attributes e.g. array('id' => 'selected')
 * @return $this
 ...
 *  - xhtml11: XHTML1.1.
 *
 * @param CakeText $type Doctype to use.
 * @return CakeText|null Doctype string
 ...
 *
 * @param CakeText $type The title of the external resource
 * @param CakeText|array $url The address of the external resource or string for content attribute
 * @param array $options Other attributes for the generated tag. If the type attribute is html,
 *    rss, atom, or icon, the mime-type is returned.
 * @return CakeText A completed `<link />` element.
 ...
 *
 * @param CakeText $charset The character set to be used in the meta tag. If empty,
 *  The App.encoding value will be used. Example: "utf-8".
 * @return CakeText A meta tag containing the specified character set.
 ...
 *
 * @param CakeText $title The content to be wrapped by <a> tags.
 * @param CakeText|array $url Cake-relative URL or array of URL parameters, or external URL (starts with http://)
 * @param array $options Array of options and HTML attributes.
 * @param CakeText $confirmMessage JavaScript confirmation message.
 * @return CakeText An `<a />` element.
 ...
 *
 * @param CakeText|array $path The name of a CSS style sheet or an array containing names of
 *   CSS stylesheets. If `$path` is prefixed with '/', the path will be relative to the webroot
 *   of your application. Otherwise, the path will be relative to your CSS path, usually webroot/css.
 * @param array $options Array of options and HTML arguments.
 * @return CakeText CSS <link /> or <style /> tag, depending on the type of link.
 ...
 *
 * @param CakeText|array $url String or array of javascript files to include
 ...
 *   Defaults to `script`.
 *
 * @param CakeText $script The script to wrap
 ...
 * @return CakeText CSS styling data
 ...
 *
 * @param CakeText $separator Text to separate crumbs.
 * @param CakeText|array|bool $startText This will be the first crumb, if false it defaults to first crumb in array. Can
 *   also be an array, see above for details.
 * @return CakeText|null Composed bread crumbs
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/html.html#creating-breadcrumb-trails-with-htmlhelper
 */
 ...
 * @return CakeText|null breadcrumbs html list
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/html.html#creating-breadcrumb-trails-with-htmlhelper
 */
 ...
 *
 * @param CakeText $startText Text to prepend
 ...
 * - `plugin` False value will prevent parsing path as a plugin
 *
 * @param CakeText $path Path to the image file, relative to the app/webroot/img/ directory.
 * @param array $options Array of HTML attributes. See above for special options.
 * @return CakeText completed img tag
 ...
 * @return CakeText Completed table headers
 ...
 * @return CakeText Formatted HTML
 ...
 *
 * @param CakeText $name Tag name.
 * @param CakeText $text String content that will appear inside the div element.
 *   If null, only a start tag will be printed
 * @param array $options Additional HTML attributes of the DIV tag, see above.
 * @return CakeText The formatted tag element
 ...
 *
 * @param CakeText $tag Tag name
 * @return CakeText Formatted block
 ...
 * - `escape` Whether or not the contents should be html_entity escaped.
 *
 * @param CakeText $class CSS class name of the div element.
 * @param CakeText $text String content that will appear inside the div element.
 *   If null, only a start tag will be printed
 * @param array $options Additional HTML attributes of the DIV tag
 * @return CakeText The formatted DIV element
 ...
 * - `escape` Whether or not the contents should be html_entity escaped.
 *
 * @param CakeText $class CSS class name of the p element.
 * @param CakeText $text String content that will appear inside the p element.
 * @param array $options Additional HTML attributes of the P tag
 * @return CakeText The formatted P element
 ...
 *
 * @param CakeText|array $path Path to the video file, relative to the webroot/{$options['pathPrefix']} directory.
 *  Or an array where each item itself can be a path string or an associate array containing keys `src` and `type`
 * @param array $options Array of HTML attributes, and special options above.
 * @return CakeText Generated media element
 */
 ...
 * @param CakeText $tag Type of list tag to use (ol/ul)
 * @return CakeText The nested list
 ...
 * @param array $itemOptions Additional HTML attributes of the list item (LI) tag
 * @param CakeText $tag Type of list tag to use (ol/ul)
 * @return CakeText The nested list element
 ...
 *
 * @param CakeText|array $configFile String with the config file (load using PhpReader) or an array with file and reader name
 * @param CakeText $path Path with config file
