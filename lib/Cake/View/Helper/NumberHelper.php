 ...
 * @param CakeText $currency Shortcut to default options. Valid values are 'USD', 'EUR', 'GBP', otherwise
 ...
 *
 * @param CakeText $currency The currency to be used in the future.
