 ...
 * @param CakeText|array $settings Settings array contains name of engine helper.
 */
 ...
 *
 * @param CakeText $method Method to be called
 ...
 *
 * @param CakeText $script Script string to add to the buffer.
 ...
 * @param CakeText|array $url Mixed either a string URL or a CakePHP URL array.
 * @param array $options Options for both the HTML element and Js::request()
 * @return CakeText Completed link. If buffering is disabled a script tag will be returned as well.
 ...
 *
 * @param CakeText|array $one Either an array of variables to set, or the name of the variable to set.
 * @param CakeText|array $two If $one is a string, $two is the value for that key.
 * @return void
 ...
 *
 * @param CakeText $caption The display text of the submit button.
 * @param array $options Array of options to use. See the options for the above mentioned methods.
 * @return CakeText Completed submit button.
