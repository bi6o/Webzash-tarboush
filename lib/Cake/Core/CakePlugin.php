 ...
 *
 * @param CakeText|array $plugin name of the plugin to be loaded in CamelCase format or array or plugins to load
 ...
 *
 * @param CakeText $plugin name of the plugin in CamelCase format
 * @return CakeText path to the plugin folder
 ...
 *
 * @param CakeText $plugin name of the plugin
 * @return mixed
 ...
 *
 * @param CakeText $plugin name of the plugin, if null will operate on all plugins having enabled the
 ...
 *
 * @param CakeText $plugin Plugin name to check.
 ...
 *
 * @param CakeText $plugin name of the plugin to forget
 * @return void
 */
 ...
 *
 * @param CakeText $file File to include
