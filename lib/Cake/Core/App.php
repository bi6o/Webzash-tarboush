 ...
 *
 * @param CakeText $type type of path
 * @param CakeText $plugin name of plugin
 * @return array
 ...
 * @param bool|CakeText $mode App::RESET will set paths, App::APPEND with append paths, App::PREPEND will prepend paths (default)
 ...
 *
 * @param CakeText $plugin CamelCased/lower_cased plugin name to find the path of.
 * @return CakeText full path to the plugin.
 ...
 *
 * @param CakeText $theme theme name to find the path of.
 * @return CakeText full path to the theme.
 ...
 *
 * @param CakeText $type Package type.
 ...
 *
 * @param CakeText $type Type of object, i.e. 'Model', 'Controller', 'View/Helper', 'file', 'class' or 'plugin'
 * @param CakeText|array $path Optional Scan only the path given. If null, paths for the chosen type will be used.
 ...
 *
 * @param CakeText $className the name of the class to configure package for
 * @param CakeText $location the package name
 * @return void
 ...
 *
 * @param CakeText $className the name of the class to load
 * @return bool
 */
 ...
 *
 * @param CakeText $className name of the class to obtain the package name from
 * @return CakeText|null Package name, or null if not declared
 ...
 *
 * @param CakeText|array $type The type of Class if passed as a string, or all params can be passed as
 *   a single array to $type.
 * @param CakeText $name Name of the Class or a unique name for the file
 ...
 * @param CakeText $file full name of the file to search for including extension
 ...
 *
 * @param CakeText $name unique name of the file for identifying it inside the application
 * @param CakeText $plugin camel cased plugin name if any
 * @param CakeText $type name of the packed where the class is located
 * @param CakeText $originalType type name as supplied initially by the user
 ...
 * @param CakeText $file filename if known, the $name param will be used otherwise
 ...
 * @param CakeText $name unique name of the file for identifying it inside the application
 * @param CakeText $plugin camel cased plugin name if any
 * @param CakeText $file file name if known
 * @param CakeText $ext file extension if known
 ...
 *
 * @param CakeText $file full path to file
 * @param CakeText $name unique name for this map
 * @param CakeText $plugin camelized if object is from a plugin, the name of the plugin
 * @return void
 */
 ...
 *
 * @param CakeText $name unique name
 * @param CakeText $plugin camelized if object is from a plugin, the name of the plugin
