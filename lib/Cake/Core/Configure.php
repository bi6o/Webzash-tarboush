 ...
 * }}}
 *
 * @param CakeText|array $config The key to write, can be a dot notation value.
 ...
 * }}}
 *
 * @param CakeText $var Variable to obtain. Use '.' to access array elements.
 ...
 *
 * @param CakeText $var Variable name to check for
 ...
 * }}}
 *
 * @param CakeText $var the var to be deleted
 * @return void
 ...
 *
 * @param CakeText $name The name of the reader being configured. This alias is used later to
 ...
 *
 * @param CakeText $name Name to check. If null returns all configured reader names.
 ...
 *
 * @param CakeText $name Name of the reader to drop.
 * @return bool Success
 */
 ...
 *
 * @param CakeText $key name of configuration resource to load.
 * @param CakeText $config Name of the configured reader to use to read the resource identified by $key.
 ...
 *
 * @param CakeText $key The identifier to create in the config adapter.
 *   This could be a filename or a cache key depending on the adapter being used.
 * @param CakeText $config The name of the configured adapter to dump data with.
 ...
 *
 * @param CakeText $config The name of the configured adapter
 ...
 *
 * @return CakeText Current version of CakePHP
 */
 ...
 *
 * @param CakeText $name The storage name for the saved configuration.
 * @param CakeText $cacheConfig The cache configuration to save into. Defaults to 'default'
 ...
 *
 * @param CakeText $name Name of the stored config file to load.
 * @param CakeText $cacheConfig Name of the Cache configuration to read from.
 * @return bool Success.
 */
