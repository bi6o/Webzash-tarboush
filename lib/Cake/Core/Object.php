 ...
 *
 * @return CakeText The name of this class
 */
 ...
 *
 * @param CakeText|array $url String or array-based URL. Unlike other URL arrays in CakePHP, this
 ...
 *
 * @param CakeText $method Name of the method to call
 ...
 * testing easier.
 *
 * @param int|CakeText $status see http://php.net/exit for values
 * @return void
 */
 ...
 *
 * @param CakeText $msg Log message
 * @param int $type Error type constant. Defined in app/Config/core.php.
 * @param null|CakeText|array $scope The scope(s) a log message is being created in.
 ...
 * @param CakeText $class The class to merge the property with.
