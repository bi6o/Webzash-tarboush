 ...
 *
 * @param CakeText $table Table name you want returned.
 * @param array $fields Array of field information to generate the table with.
 * @return CakeText Variable declaration for a schema class.
 */
 ...
 * table.
 *
 * @param CakeText $prefix Table prefix.
 * @param CakeText $table Full table name.
 * @return CakeText Prefix-less table name.
 */
 ...
 *
 * @param CakeText $path Filesystem path to the file.
 * @param CakeText $file Filesystem basename of the file.
