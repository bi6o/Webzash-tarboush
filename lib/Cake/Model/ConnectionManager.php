 ...
 *
 * @param CakeText $name The name of the DataSource, as defined in app/Config/database.php
 ...
 * @return CakeText|null Datasource name, or null if source is not present
 ...
 *
 * @param CakeText|array $connName A string name of the connection, as defined in app/Config/database.php,
 ...
 *
 * @param CakeText $name The DataSource name
 ...
 *
 * @param CakeText $name the connection name as it was created
 ...
 *
 * @param CakeText $name Connection name
 * @return void
