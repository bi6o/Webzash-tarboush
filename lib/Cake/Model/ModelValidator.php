 ...
 *
 * @param CakeText $options An optional array of custom options to be made available in the beforeValidate callback
 ...
 * @param CakeText $message Validation message explaining why the rule failed, defaults to true.
 * @return void
 */
 ...
 *
 * @param CakeText $name [optional] The fieldname to fetch. Defaults to null.
 ...
 *
 * @param CakeText $validationDomain [optional] The validation domain to be used.
 * @return $this
 */
 ...
 *
 * @param CakeText $field name of the field to check
 * @return bool
 */
 ...
 *
 * @param CakeText $field name of the field to set
 ...
 *
 * @param CakeText $field name of the field to unset
 * @return void
 */
 ...
 * }}}
 *
 * @param CakeText $field The name of the field where the rule is to be added
 * @param CakeText|array|CakeValidationSet $name name of the rule to be added or list of rules for the field
 ...
 * }}}
 *
 * @param CakeText $field The name of the field from which the rule will be removed
 * @param CakeText $rule the name of the rule to be removed
 * @return $this
 */
