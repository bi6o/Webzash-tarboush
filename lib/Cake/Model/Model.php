 ...
 *
 * @param bool|int|CakeText|array $id Set this ID for this model on startup,
 * can also be an array of options, see above.
 * @param CakeText $table Name of database table to use.
 * @param CakeText $ds DataSource connection name.
 */
 ...
 *
 * @param CakeText $method Name of method to call.
 ...
 *
 * @param CakeText $name variable tested for existence in class
 ...
 *
 * @param CakeText $name variable requested for it's value or reference
 ...
 *
 * @param CakeText $assoc Association name
 * @param CakeText $className Class name
 * @param CakeText $plugin name of the plugin where $className is located
 ...
 *
 * @param CakeText $type 'belongsTo', 'hasOne', 'hasMany', 'hasAndBelongsToMany'
 * @param CakeText $assocKey Association key.
 * @return void
 */
 ...
 *
 * @param CakeText $tableName Name of the custom table
 ...
 *
 * @param CakeText|array|SimpleXmlElement|DomNode $one Array or string of data
 * @param CakeText $two Value string for the alternative indata method
 ...
 *
 * @param CakeText $field The name of the field to be deconstructed
 ...
 *
 * @param bool|CakeText $field Set to true to reload schema, or a string to return a specific field
 ...
 *
 * @param CakeText $column The name of the model column
 * @return CakeText Column type
 */
 ...
 *
 * @param CakeText|array $name Name of field to look for, or an array of names
 ...
 *
 * @param CakeText $method The method to be called.
 ...
 *
 * @param CakeText $field Name of field to look for
 ...
 *
 * @param CakeText|array $fields String of single field name, or an array of field names.
 * @param int|CakeText $id The ID of the record to read
 ...
 * supplied order.
 *
 * @param CakeText $name Name of field to get
 * @param array $conditions SQL conditions (defaults to NULL)
 * @param CakeText $order SQL ORDER BY fragment
 * @return CakeText field contents, or false if not found
 ...
 * model ID.
 *
 * @param CakeText $name Name of the table field
 ...
 *
 * @param CakeText $field the field to check
 * @return bool
 */
 ...
 * @param int|CakeText $id ID of record in this model
 ...
 *
 * @param CakeText $key fieldname to be added to list
 ...
 *
 * @param int|CakeText $id ID of record to delete
 ...
 *
 * @param CakeText $id ID of record that was deleted
 * @param bool $cascade Set to true to delete records that depend on this record
 * @return void
 */
 ...
 *
 * @param int|CakeText $id ID of record to check for existence
 ...
 *
 * @param CakeText $type Type of find operation (all / first / count / neighbors / list / threaded)
 ...
 *
 * @param CakeText $state Either "before" or "after"
 ...
 *
 * @param array|CakeText $options An optional array of custom options to be made available in the beforeValidate callback
 ...
 *
 * @param CakeText $field The name of the field to invalidate
 ...
 *
 * @param CakeText $field Returns true if the input string ends in "_id"
 ...
 *
 * @param CakeText $field Field to escape (e.g: id)
 * @param CakeText $alias Alias for the model (e.g: Post)
 * @return CakeText The name of the escaped field for this Model (i.e. id becomes `Post`.`id`).
 */
 ...
 *
 * @param int|CakeText $id Last inserted ID
 * @return void
 */
 ...
 *
 * @param CakeText $dataSource The name of the DataSource, as defined in app/Config/database.php
 * @return void
 ...
 *
 * @param CakeText $type Only result associations of this type
 ...
 *
 * @param CakeText|array $assoc The model to be joined
 ...
 *
 * @param CakeText $type If null this deletes cached views if Cache.check is true
