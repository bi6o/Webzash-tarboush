 ...
 *
 * @param Model|CakeText $model Name of database table to inspect
 ...
 *
 * @param CakeText $source Name of the database table
 * @param CakeText $field Name of the ID database field. Defaults to "id"
 * @return int
 */
 ...
 *
 * @param CakeText|Model $table Either a full table name (with prefix) as a string, or a model object
 * @param CakeText $field Name of the ID database field. Defaults to "id"
 * @return CakeText The associated sequence name from the sequence map, defaults to "{$table}_{$field}_seq"
 */
 ...
 *
 * @param CakeText|Model $table A string or model class representing the table to be truncated
 ...
 *
 * @param CakeText $data The name to format.
 ...
 * @param CakeText $table name of the table
 * @return array
 */
 ...
 *
 * @param CakeText $table Table to alter indexes for
 ...
 * @return CakeText Abstract column type (i.e. "string")
 */
 ...
 *
 * @return CakeText The database encoding
 */
 ...
 *
 * @param CakeText $type The query type.
 ...
 *
 * @return CakeText The schema name
 */
