 ...
 *
 * @param Model|CakeText $model Model object to describe, or a string table name.
 ...
 *
 * @param CakeText $type Query type
 ...
 * @param CakeText $column The column into which this data will be inserted
 ...
 *
 * @param CakeText $table The table to insert into.
 * @param CakeText $fields The fields to set.
 * @param array $values The values to set.
 * @return void
 */
 ...
 * @param CakeText $table The table to make indexes for.
 * @return CakeText
 */
 ...
 *
 * @param Model|CakeText $model Model instance of table name
 * @return CakeText
 */
