 ...
 *
 * @param Model|CakeText $model Either the model or table name you want described.
 ...
 * @return CakeText The completed index.
 */
 ...
 *
 * @param CakeText $type The type of statement being rendered.
