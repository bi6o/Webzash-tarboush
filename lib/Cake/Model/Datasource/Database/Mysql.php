 ...
 *
 * @param CakeText $name Collation name
 * @return CakeText Character set name
 */
 ...
 *
 * @param Model|CakeText $model Name of database table to inspect or model instance
 ...
 *
 * @param CakeText $enc Database encoding
 * @return bool
 */
 ...
 *
 * @param CakeText $table Table to alter parameters for.
 ...
 * @param CakeText $table Optional table name, not used
 ...
 * @param CakeText $column The column for which to generate the index length
 * @return CakeText Formatted length part of an index field
 */
 ...
 *
 * @param CakeText $name Table name to get parameters
 * @return array Array of table names in the database
 */
