 ...
 * Pseudo constructor.
 *
 * @param CakeText $base The base path for the Session
 * @return void
 */
 ...
 *
 * @param CakeText $name Variable name to check for
 ...
 *
 * @param CakeText $id Id to replace the current session id
 * @return CakeText Session id
 */
 ...
 *
 * @param CakeText $name Session variable to remove
 * @return bool Success
 */
 ...
 * @return CakeText Error as string
 */
 ...
 *
 * @param CakeText $userAgent Set the user agent
 * @return CakeText Current user agent
 */
 ...
 *
 * @param CakeText|array $name The name of the session variable (or a path as sent to Set.extract)
 ...
 *
 * @param CakeText|array $name Name of variable
 * @param CakeText $value Value to write
 ...
 *
 * @param CakeText $handler Handler name.
 * @return void
 ...
 *
 * @param CakeText $name Config name.
 * @return bool|array
 */
 ...
 * @param CakeText $errorMessage Description of the error
 * @return void
 */
