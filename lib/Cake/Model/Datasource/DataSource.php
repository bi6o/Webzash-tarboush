 ...
 *
 * @param Model|CakeText $model The model to describe.
 ...
 *
 * @param CakeText $real Real column type (i.e. "varchar(255)")
 ...
 *
 * @param CakeText $object The name of the object (model) to cache
 ...
 *
 * @param CakeText $query Query string needing replacements done.
 * @param array $data Array of data with values that will be inserted in placeholders.
 * @param CakeText $association Name of association model being replaced.
 ...
 *
 * @param Model $Model Model instance
 * @param CakeText $key Key name to make
 * @return CakeText Key name for model.
 */
 ...
 *
 * @return CakeText|null The schema name
 */
