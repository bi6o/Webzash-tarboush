 ...
 *
 * @return CakeText The database version
 */
 ...
 *
 * @param CakeText $data String to be prepared for use in an SQL statement
 * @param CakeText $column The column datatype into which this data will be inserted.
 * @return CakeText Quoted and escaped data
 */
 ...
 *
 * @param CakeText $identifier A SQL expression to be used as an identifier
 ...
 * are not sanitized or escaped.
 *
 * @param CakeText $expression An arbitrary SQL expression to be inserted into a query.
 ...
 *
 * @param CakeText $sql SQL statement
 ...
 * @return CakeText Error message with error number
 */
 ...
 *
 * @param CakeText $sql Some SQL to be executed.
 ...
 *
 * @param CakeText $name Name of the field
 * @param CakeText $sql SQL query
 ...
 *
 * @param CakeText $method Name of the method being cached.
 * @param CakeText $key The key name for the cache operation.
 ...
 * @param CakeText $type Association type, one of the model association types ie. hasMany.
 * @param CakeText $association Association name.
 ...
 *
 * @param Model $Model Primary model object.
 * @param CakeText $query Association query template.
 ...
 *
 * @param Model $Model Primary model object.
 * @param CakeText $query Association query.
 * @param array $ids Array of IDs of associated records.
 * @param CakeText $association Association name.
 * @return array Association results.
 */
 ...
 * @param CakeText $association Name of Model being merged.
 ...
 * @param CakeText $association The association name to merge.
 * @param CakeText $type The type of association
 ...
 * @param array $queryData An array of queryData information containing keys similar to Model::find().
 * @return CakeText String containing an SQL statement.
 ...
 *
 * @param CakeText $type Association type.
 * @param Model $Model Primary Model object.
 * @param Model $LinkModel Linked model object.
 * @param CakeText $association Association name.
 * @param array $assocData Association data.
 * @param CakeText $association2 HABTM association name.
 ...
 * @return CakeText An SQL JOIN condition to be used in a query.
 ...
 * @return CakeText An executable SQL statement.
 ...
 *
 * @param CakeText $type type of query being run. e.g select, create, update, delete, schema, alter.
 * @param array $data Array of data to insert into the query.
 * @return CakeText Rendered SQL expression to be run.
 */
 ...
 * @param CakeText $func Lowercase name of SQL function, i.e. 'count' or 'max'
 * @param array $params Function parameters (any values must be quoted manually)
 * @return CakeText An SQL calculation function
 */
 ...
 *
 * @param Model|CakeText $table A string or model class representing the table to be truncated
 ...
 * @param CakeText|array|bool $conditions Array of conditions, conditions string, null or false. If an array of conditions,
 ...
 * @param CakeText $key The key field.
 * @param CakeText $assoc The association name.
 * @return CakeText
 */
 ...
 * @param CakeText $alias Alias table name
 ...
 *
 * @param CakeText $key An SQL key snippet containing a field and optional SQL operator
 ...
 * Quotes Model.fields
 *
 * @param CakeText $conditions The conditions to quote.
 * @return CakeText or false if no match
 */
 ...
 *
 * @param CakeText $match matched string
 * @return CakeText quoted string
 */
 ...
 * @return CakeText SQL limit/offset statement
 */
 ...
 *
 * @param array|CakeText $keys Field reference, as a key (i.e. Post.title)
 * @param CakeText $direction Direction (ASC or DESC)
 * @param Model $Model Model reference (used to look for virtual field)
 * @return CakeText ORDER BY clause
 */
 ...
 *
 * @param CakeText|array $fields Group By fields
 * @param Model $Model The model to get group by fields for.
 * @return CakeText Group By clause or null.
 */
 ...
 * @param CakeText $sql SQL WHERE clause (condition only, not the "WHERE" part)
 ...
 *
 * @param CakeText $real Real database-layer column type (i.e. "varchar(255)")
 ...
 * @return CakeText|bool Converted boolean value
 */
 ...
 *
 * @param CakeText $table The table being inserted into.
 ...
 *
 * @param CakeText $table The name of the table to update.
 * @param CakeText $column The column to use when resetting the sequence value.
 ...
 *
 * @param CakeText $model Name of model to inspect
 ...
 * @param CakeText $tableName Optional. If specified only the table name given will be generated.
 ...
 * @param CakeText $table The table name.
 * @return bool
 */
 ...
 *
 * @param CakeSchema $schema An instance of a subclass of CakeSchema
 * @param CakeText $table Optional. If specified only the table name given will be generated.
 *   Otherwise, all tables defined in the schema are generated.
 * @return CakeText
 */
 ...
 * @return CakeText Drop table SQL statement
 */
 ...
 *
 * @param CakeText $columnString The partially built column string
 * @param array $columnData The array of column data.
 * @param CakeText $position The position type to use. 'beforeDefault' or 'afterDefault' are common
 * @return CakeText a built column with the field parameters added.
 */
 ...
 *
 * @param CakeText $name The table name to read.
 * @return array
 */
 ...
 *
 * @param CakeText $value The value to introspect for type data.
 * @return CakeText
 */
