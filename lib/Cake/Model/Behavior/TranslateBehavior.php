 ...
 * @param CakeText $field The field name being joined.
 * @param CakeText $aliasField The aliased field name being joined.
 * @param CakeText|array $locale The locale(s) having joins added.
 ...
 * @param CakeText|array $fields string with field or array(field1, field2=>AssocName, field3)
 ...
 *
 * @param Model $Model Model using this behavior
 * @param CakeText $field The field to update.
 * @return void
 */
 ...
 *
 * @param Model $Model using this behavior of model
 * @param CakeText|array $fields string with field, or array(field1, field2=>AssocName, field3), or null for
