 ...
 *
 * @param Model $model Model using this behavior.
 * @param CakeText|array|Model $ref Array with 'model' and 'foreign_key', model object, or string value
 * @param CakeText $type Only needed when Acl is set up as 'both', specify 'Aro' or 'Aco' to get the correct node
 * @return array|null
