 ...
 *
 * @param Model $Model Model using this behavior
 * @param int|CakeText|bool $id The ID of the record to read or false to read all top level nodes
 ...
 * @param CakeText|array $fields Either a single string of a field name, or an array of field names
 * @param CakeText $order SQL ORDER BY conditions (e.g. "price DESC" or "name ASC") defaults to the tree order
 ...
 *
 * @param Model $Model Model using this behavior
 * @param CakeText|array $conditions SQL conditions as a string or as an array('field' =>'value',...)
 * @param CakeText $keyPath A string path to the key, i.e. "{n}.Post.id"
 * @param CakeText $valuePath A string path to the value, i.e. "{n}.Post.title"
 * @param CakeText $spacer The character or characters which will be repeated
 * @param int $recursive The number of levels deep to fetch associated records
 ...
 * @param Model $Model Model using this behavior
 * @param int|CakeText $id The ID of the record to read
 * @param CakeText|array $fields Fields to get
 * @param int $recursive The number of levels deep to fetch associated records
 ...
 *
 * @param Model $Model Model using this behavior
 * @param int|CakeText $id The ID of the record to move
 ...
 *
 * @param Model $Model Model using this behavior
 * @param CakeText $mode parent or tree
 * @param CakeText|int $missingParentAction 'return' to do nothing and return, 'delete' to
 ...
 *
 * @param Model $Model Model using this behavior
 * @param int|CakeText $id The ID of the record to remove
 ...
 *
 * @param Model $Model Model using this behavior
 * @param int|CakeText $parentId Parent record Id
 ...
 *
 * @param Model $Model Model Instance.
 * @param CakeText $scope Scoping conditions.
 * @param CakeText $right Right value
 ...
 * @param Model $Model Model instance.
 * @param CakeText $scope Scoping conditions.
 * @param CakeText $left Left value.
 ...
 * @param CakeText $dir Direction.
 * @param array $conditions Conditions.
 * @param bool $created Whether it's a new record.
 * @param CakeText $field Field type.
 * @return void
 */
