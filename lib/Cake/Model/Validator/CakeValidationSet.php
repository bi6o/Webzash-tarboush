 ...
 * Constructor
 *
 * @param CakeText $fieldName The fieldname.
 ...
 *
 * @param CakeText $validationDomain The validation domain to be used.
 * @return void
 */
 ...
 *
 * @param CakeText $name Field name.
 ...
 * }}}
 *
 * @param CakeText $name The name under which the rule should be set
 ...
 * }}}
 *
 * @param CakeText $name The name under which the rule should be unset
 * @return $this
 */
 ...
 *
 * @param CakeText $name the name of the rule as it was configured
 ...
 *
 * @param CakeText $index name of the rule
 * @return bool
 */
