 ...
 *
 * @param CakeText $eventKey The event unique identifier name with which the callback will be associated. If $callable
 ...
 * @param CakeText $eventKey The event unique identifier name with which the callback has been associated
 * @return void
 */
 ...
 * @param CakeText $eventKey optional event key name to unsubscribe the listener from
 * @return void
 */
 ...
 *
 * @param CakeText|CakeEvent $event the event key name or instance of CakeEvent
 * @return CakeEvent
 */
 ...
 *
 * @param CakeText $eventKey Event key.
 * @return array
 */
