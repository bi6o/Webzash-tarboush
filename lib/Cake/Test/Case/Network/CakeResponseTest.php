 ...
 * @param CakeText $origin
 * @param CakeText|array $domains
 * @param CakeText|array $methods
 * @param CakeText|array $headers
 * @param CakeText|bool $expectedOrigin
 * @param CakeText|bool $expectedMethods
 * @param CakeText|bool $expectedHeaders
 * @return void
 */
