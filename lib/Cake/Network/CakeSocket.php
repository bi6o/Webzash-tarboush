 ...
 *
 * @param int $code Code.
 * @param CakeText $message Message.
 * @return void
 */
 ...
 *
 * @return CakeText|null Last error
 */
 ...
 * @param CakeText $errStr Error string
 * @return void
 */
 ...
 *
 * @param CakeText $data The data to write to the socket
 * @return bool Success
 */
 ...
 *
 * @param CakeText $type can be one of 'ssl2', 'ssl3', 'ssl23' or 'tls'
 * @param CakeText $clientOrServer can be one of 'client', 'server'. Default is 'client'
