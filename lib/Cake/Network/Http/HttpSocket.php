 ...
 *
 * @param CakeText|array $config Configuration information, either a string URL or an array of options.
 */
 ...
 * `$http->configAuth();`
 *
 * @param CakeText $method Authentication method (ie. Basic, Digest). If empty, disable authentication
 * @param CakeText|array $user Username for authentication. Can be an array with settings to authentication class
 * @param CakeText $pass Password for authentication
 * @return void
 */
 ...
 * Set proxy settings
 *
 * @param CakeText|array $host Proxy host. Can be an array with settings to authentication class
 * @param int $port Port. Default 3128.
 * @param CakeText $method Proxy method (ie, Basic, Digest). If empty, disable proxy authentication
 * @param CakeText $user Username if your proxy need authentication
 * @param CakeText $pass Password to proxy authentication
 * @return void
 */
 ...
 *
 * @param CakeText|array $request Either an URI string, or an array defining host/uri
 ...
 * }}}
 *
 * @param CakeText|array $uri URI to request. Either a string uri, or a uri array, see HttpSocket::_parseUri()
 ...
 * }}}
 *
 * @param CakeText|array $uri URI to request. See HttpSocket::_parseUri()
 ...
 *
 * @param CakeText|array $uri URI to request (see {@link _parseUri()})
 * @param array $data Array of request body data keys and values.
 * @param array $request An indexed array with indexes such as 'method' or uri
 * @return mixed Result of request
 */
 ...
 *
 * @param CakeText|array $url Either a string or array of URL options to create a URL with.
 * @param CakeText $uriTemplate A template string to use for URL formatting.
 ...
 *
 * @param CakeText|array $uri URI, See HttpSocket::_parseUri()
 ...
 *
 * @param CakeText $host The host you're connecting to.
 * @return void
 */
 ...
 *
 * @param CakeText|array $uri Either A $uri array, or a request string. Will use $this->config if left empty.
 * @param CakeText $uriTemplate The Uri template/format to use.
 ...
 *
 * @param CakeText|array $uri URI to parse
 ...
 *
 * @param CakeText|array $query A query string to parse into an array or an array to return directly "as is"
 ...
 * @param CakeText $versionToken The version token to use, defaults to HTTP/1.1
 * @return CakeText Request line
 * @throws SocketException
 */
 ...
 * @param CakeText $mode Mode
 * @return CakeText Header built from array
 */
 ...
 * @return CakeText Cookie header string to be sent with the request.
 */
 ...
 *
 * @param CakeText $token Token to escape
 * @param array $chars Characters to escape
 * @return CakeText Escaped token
 */
