 ...
 * Constructor
 *
 * @param CakeText $message Message to parse.
 */
 ...
 *
 * @param CakeText $name Header name.
 ...
 *
 * @param CakeText $body A string containing the body to decode.
 * @param CakeText|bool $encoding Can be false in case no encoding is being used, or a string representing the encoding.
 ...
 * a result.
 *
 * @param CakeText $body A string containing the chunked body to decode.
 * @return mixed Array of response headers and body or false.
 * @throws SocketException
 */
 ...
 *
 * @param CakeText $token Token to unescape.
 * @param array $chars Characters to unescape.
 * @return CakeText Unescaped token
 */
 ...
 *
 * @param CakeText $offset Offset to check.
 * @return bool
 */
 ...
 *
 * @param CakeText $offset Offset to get.
 * @return mixed
 */
 ...
 *
 * @param CakeText $offset Offset to set.
 ...
 *
 * @param CakeText $offset Offset to unset.
 * @return void
 */
