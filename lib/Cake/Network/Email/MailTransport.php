 ...
 *
 * @param CakeText $to email's recipient
 * @param CakeText $subject email's subject
 * @param CakeText $message email's body
 * @param CakeText $headers email's custom headers
 * @param CakeText $params additional params for sending email, will be ignored when in safe_mode
