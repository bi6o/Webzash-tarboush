 ...
 * Constructor
 *
 * @param array|CakeText $config Array of configs, or string to load configs from email.php
 */
 ...
 * From
 *
 * @param CakeText|array $email Null to get, String with email,
 *   Array with email as key, name as value or email as value (without name)
 * @param CakeText $name Name
 ...
 *
 * @param CakeText $charset Character set.
 * @return CakeText this->charset
 */
 ...
 *
 * @param CakeText $regex for email address validation
 * @return CakeText|$this
 */
 ...
 * Set email
 *
 * @param CakeText $varName Property name
 * @param CakeText|array $email String with email,
 *   Array with email as key, name as value or email as value (without name)
 * @param CakeText $name Name
 * @return $this
 */
 ...
 *   Array with email as key, name as value or email as value (without name)
 * @param CakeText $name Name
 * @param CakeText $throwMessage Exception message
 * @return $this
 * @throws SocketException
 */
 ...
 * Get/Set Subject.
 *
 * @param CakeText $subject Subject string.
 * @return CakeText|$this
 */
 ...
 * Template and layout
 *
 * @param bool|CakeText $template Template name or null to not use
 * @param bool|CakeText $layout Layout name or null to not use
 * @return array|$this
 */
 ...
 *
 * @param CakeText $viewClass View class name.
 * @return CakeText|$this
 */
 ...
 *
 * @param CakeText $theme Theme name.
 * @return CakeText|$this
 */
 ...
 * Email format
 *
 * @param CakeText $format Formatting string.
 * @return CakeText|$this
 * @throws SocketException
 */
 ...
 * Transport name
 *
 * @param CakeText $name Transport name.
 * @return CakeText|$this
 */
 ...
 * Message-ID
 *
 * @param bool|CakeText $message True to generate a new Message-ID, False to ignore (not send in email), String to set as Message-ID
 * @return bool|CakeText|$this
 * @throws SocketException
 */
 ...
 *
 * @param CakeText $domain Manually set the domain for CLI mailing
 * @return CakeText|$this
 */
 ...
 *
 * @param CakeText|array $attachments String with the filename or array with filenames
 ...
 *
 * @param CakeText $type Use MESSAGE_* constants or null to return the full message as array
 * @return CakeText|array String if have type, array if type is null
 */
 ...
 *
 * @param CakeText|array $config String with configuration name (from email.php), array with config or null to return current config
 * @return CakeText|array|$this
 */
 ...
 *
 * @param CakeText|array $content String with message or array with messages
 * @return array
 * @throws SocketException
 */
 ...
 *
 * @param CakeText|array $to Address to send (see CakeEmail::to()). If null, will try to use 'to' from transport config
 * @param CakeText $subject String of subject or null to use 'subject' from transport config
 * @param CakeText|array $message String with message or array with variables to be used in render
 * @param CakeText|array $transportConfig String to use config from EmailConfig or array with configs
 ...
 *
 * @param CakeText $text String to encode
 * @return CakeText Encoded string
 */
 ...
 *
 * @param CakeText $text The text to be converted
 * @param CakeText $charset the target encoding
 * @return CakeText
 */
 ...
 *
 * @param CakeText $message Message to wrap
 ...
 *
 * @param CakeText $boundary Boundary to use. If null, will default to $this->_boundary
 ...
 *
 * @param CakeText $path The absolute path to the file to read.
 * @return CakeText File contents in base64 encoding
 */
 ...
 *
 * @param CakeText $content The content passed in from send() in most cases.
