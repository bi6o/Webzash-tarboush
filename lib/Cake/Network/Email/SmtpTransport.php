 ...
 *
 * @param CakeText $email The email address to send with the command.
 * @return CakeText
 */
 ...
 *
 * @param CakeText $data data to be sent to SMTP server
 * @param CakeText|bool $checkCode code to check for in server response, false to skip
 * @return void
 * @throws SocketException
 */
