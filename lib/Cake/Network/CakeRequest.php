 ...
 * Constructor
 *
 * @param CakeText $url Trimmed URL string to use. Should not contain the application base path.
 ...
 *
 * @return CakeText URI The CakePHP request path that is being accessed.
 */
 ...
 *
 * @param CakeText $path The dot separated path to insert $data into.
 * @param array $data The data to traverse/insert.
 * @param CakeText $field The terminal field name, which is the top level key in $_FILES.
 * @return void
 */
 ...
 * @return CakeText The referring address for this request.
 */
 ...
 *
 * @param CakeText $name The method called
 ...
 *
 * @param CakeText $name The property being accessed.
 ...
 *
 * @param CakeText|array $type The type of request you want to check. If an array
 ...
 *
 * @param CakeText $name The name of the detector.
 ...
 * @return CakeText the current request URL including query string args.
 */
 ...
 *
 * @param CakeText $name Name of the header you want.
 ...
 *
 * @return CakeText The name of the HTTP method used.
 */
 ...
 * @return CakeText Domain name without subdomains.
 */
 ...
 * by the client.
 *
 * @param CakeText $type The content type to check for. Leave null to get all types a client accepts.
 ...
 *
 * @param CakeText $language The language to test.
 ...
 *
 * @param CakeText $header Header to parse.
 * @return array
 */
 ...
 *
 * @param CakeText $name Query string variable name
 ...
 *
 * @param CakeText $name Dot separated name of the value to read/write, one or more args.
 ...
 *
 * @param CakeText $name The name of the parameter to get.
 ...
 *
 * @param CakeText $callback A decoding callback that will convert the string data to another
 ...
 *
 * @param CakeText|array $methods Allowed HTTP request methods.
 * @return bool true
 ...
 *
 * @return CakeText contents of php://input
 */
 ...
 *
 * @param CakeText $name Name of the key being accessed.
 * @return mixed
 */
 ...
 *
 * @param CakeText $name Name of the key being written
 ...
 *
 * @param CakeText $name thing to check.
 * @return bool
 */
 ...
 *
 * @param CakeText $name Name to unset.
 * @return void
 */
