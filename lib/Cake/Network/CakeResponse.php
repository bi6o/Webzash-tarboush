 ...
 *
 * @param CakeText $name the header name
 * @param CakeText $value the header value
 * @return void
 */
 ...
 *
 * @param CakeText $content string to send as response body
 * @return void
 */
 ...
 *
 * @param CakeText|array $header An array of header strings or a single header string
 *	- an associative array of "header name" => "header value" is also accepted
 *	- an array of string headers is also accepted
 * @param CakeText|array $value The header value(s)
 ...
 *
 * @param null|CakeText $url Either null to get the current location, or a string to set one.
 * @return CakeText|null When setting the location null will be returned. When reading the location
 ...
 *
 * @param CakeText $content the string message to be sent
 * @return CakeText current message buffer if $content param is passed as null
 */
 ...
 *
 * @param CakeText $contentType Content type key.
 ...
 *
 * @param CakeText $alias the content type alias to map
 ...
 *
 * @param CakeText|array $ctype Either a string content type to map, or an array of types.
 ...
 *
 * @param CakeText $charset Character set string.
 * @return CakeText current charset
 */
 ...
 *
 * @param CakeText $since a valid time since the response text has not been modified
 * @param CakeText $time a valid time for cache expiry
 * @return void
 */
 ...
 *
 * @param CakeText|DateTime $time Valid time string or DateTime object.
 * @return CakeText
 */
 ...
 * value is returned
 *
 * @param CakeText|array $cacheVariances a single Vary string or an array
 ...
 * as timezone
 *
 * @param CakeText|DateTime $time Valid time string or unix timestamp or DateTime object.
 * @return DateTime
 */
 ...
 *
 * @param CakeText $filename the name of the file as the browser will download the response
 * @return void
 */
 ...
 *
 * @param CakeText $protocol Protocol to be used for sending response.
 * @return CakeText protocol currently set
 */
 ...
 *
 * @param CakeRequest $request Request object
 * @param CakeText|array $allowedDomains List of allowed domains, see method description for more details
 * @param CakeText|array $allowedMethods List of HTTP verbs allowed
 * @param CakeText|array $allowedHeaders List of HTTP headers allowed
 * @return void
 */
 ...
 *
 * @param CakeText $path Path to file. If the path is not an absolute path that resolves
 ...
 * @param CakeText $httpRange The range to use.
 * @return void
 */
