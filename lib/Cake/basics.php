 ...
 * @param CakeText $sortBy Sort by this key
 * @param CakeText $order Sort order asc/desc (ascending or descending).
 ...
 *
 * @param CakeText|array|object $text Text to wrap through htmlspecialchars. Also works with arrays, and objects.
 *    Arrays will be mapped and have all their elements escaped. Objects will be string cast if they
 *    implement a `__toString` method. Otherwise the class name will be used.
 * @param bool $double Encode existing html entities
 * @param CakeText $charset Character set to use when escaping. Defaults to config value in 'App.encoding' or 'UTF-8'
 * @return CakeText Wrapped text
 ...
 * @param CakeText $plugin Optional default plugin to use if no plugin is found. Defaults to null.
 ...
 *
 * @param CakeText $key Environment variable name.
 * @return CakeText|bool|null Environment variable setting.
 ...
 *
 * @param CakeText $path File path within /tmp to save the file.
 * @param mixed $data The data to save to the temporary file.
 * @param mixed $expires A valid strtotime string when the data expires.
 * @param CakeText $target The target of the cached data; either 'cache' or 'public'.
 ...
 *
 * @param CakeText|array $params As String name to be searched for deletion, if name is a directory all files in
 *   directory will be deleted. If array, names to be searched for deletion. If clearCache() without params,
 *   all files in app/tmp/cache/views will be deleted
 * @param CakeText $type Directory in tmp/cache defaults to view directory
 * @param CakeText $ext The file extension you are deleting
 ...
 *
 * @param CakeText $singular Text to translate
 ...
 *
 * @param CakeText $singular Singular text to translate
 * @param CakeText $plural Plural text
 ...
 *
 * @param CakeText $domain Domain
 * @param CakeText $msg String to translate
 * @param mixed $args Array with arguments or multiple arguments in function
 ...
 *
 * @param CakeText $domain Domain
 * @param CakeText $singular Singular string to translate
 * @param CakeText $plural Plural
 * @param int $count Count
 * @param mixed $args Array with arguments or multiple arguments in function
 ...
 *
 * @param CakeText $domain Domain
 * @param CakeText $msg Message to translate
 ...
 *
 * @param CakeText $message Message to write to log
 * @return void
 ...
 *
 * @param CakeText $file File to look for
 ...
 * @return CakeText with underscore remove from start and end of string
