 ...
 *
 * @param CakeText|array $key Key for the value
 * @param mixed $value Value
 * @param bool $encrypt Set to true to encrypt value, false otherwise
 * @param int|CakeText $expires Can be either the number of seconds until a cookie
 ...
 *
 * @param CakeText $key Key of the value to be obtained. If none specified, obtain map key => values
 * @return CakeText|null Value for specified key
 ...
 *
 * @param CakeText $key Variable name to check for
 ...
 *
 * @param CakeText $key Key of the value to be deleted
 * @return void
 ...
 * written any cookies.
 *
 * @param CakeText $type Encryption method
 * @return void
 */
 ...
 *
 * @param int|CakeText $expires Can be either Unix timestamp, or date string
 ...
 * Set cookie
 *
 * @param CakeText $name Name for cookie
 * @param CakeText $value Value for cookie
 * @return void
 */
 ...
 *
 * @param CakeText $name Name of cookie
 * @return void
 */
 ...
 *
 * @param CakeText $value Value to encrypt
 * @return CakeText Encoded values
 */
 ...
 * @return CakeText decrypted string
 */
 ...
 *
 * @param CakeText $value The value to decode & decrypt.
 * @return CakeText Decoded value.
 */
 ...
 * @return CakeText A json encoded string.
 */
 ...
 *
 * @param CakeText $string A string containing JSON encoded data, or a bare string.
