 ...
 *
 * @param CakeText|array $password Plain text password to hash or array of data
 *   required to generate password hash.
 * @return CakeText Password hash
 */
 ...
 *
 * @param CakeText|array $password Plain text password to hash or data array.
 * @param CakeText $hashedPassword Existing hashed password.
