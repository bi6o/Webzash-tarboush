 ...
 *
 * @param CakeText $digest The raw digest authentication headers.
 ...
 * @param CakeText $password The digest hash password generated with DigestAuthenticate::password()
 * @return CakeText Response hash
 */
 ...
 *
 * @param CakeText $username The username to use in the digest hash.
 * @param CakeText $password The unhashed password to make a digest hash for.
 * @param CakeText $realm The realm the password is for.
 * @return CakeText the hashed password that can later be used with Digest authentication.
 */
 ...
 *
 * @return CakeText Headers for logging in.
 */
