 ...
 *
 * @param CakeText|array $username The username/identifier, or an array of find conditions.
 * @param CakeText $password The password, only used if $username param is string.
 ...
 * in the datasource.
 *
 * @param CakeText $password The plain text password.
 * @return CakeText The hashed form of the password.
