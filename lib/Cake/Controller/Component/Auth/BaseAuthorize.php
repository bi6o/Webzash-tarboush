 ...
 * @param CakeText $settings An array of settings. This class does not use any settings.
 */
 ...
 * @param CakeText $path Path format.
 * @return CakeText the action path for the given request.
 */
