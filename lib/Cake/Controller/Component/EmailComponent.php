 ...
 *
 * @param CakeText|array $content Either an array of text lines, or a string with contents
 *  If you are rendering a template this variable will be sent to the templates as `$content`
 * @param CakeText $template Template to use when sending email
 * @param CakeText $layout Layout to use to enclose email body
 * @return bool Success
 */
 ...
 *
 * @param CakeText $attachment Attachment file name to find
 * @return CakeText|null Path to located file
 */
 ...
 *
 * @param CakeText $value Value to strip
 * @param bool $message Set to true to indicate main message content
 * @return CakeText Stripped value
 */
