 ...
 *
 * @param Controller $controller A reference to the controller
 * @param CakeText|array $url A string or array containing the redirect location
 ...
 *
 * @return CakeText|bool When Ajax the prototype version of component making the call otherwise false
 */
 ...
 * startup method.
 *
 * @param CakeText $name The name of the Content-type, i.e. "html", "xml", "css"
 * @param CakeText|array $type The Content-type or array of Content-types assigned to the name,
 ...
 *
 * @return CakeText Server address
 ...
 * @return CakeText Client IP address
 ...
 *
 * @param CakeText|array $type Can be null (or no parameter), a string type name, or an
 *   array of types
 ...
 *
 * @param CakeText|array $type Can be null (or no parameter), a string type name, or an array of types
 ...
 * HTTP_ACCEPT.
 *
 * @param CakeText|array $type An optional array of 'friendly' content-type names, i.e.
 *   'html', 'xml', 'js', etc.
 ...
 * @param CakeText $type Type of response to send (e.g: 'ajax')
 ...
 *
 * @param CakeText|array $type Friendly type name, i.e. 'html' or 'xml', or a full content-type,
 ...
 * @return CakeText|array Aliases for the types provided.
 ...
 *
 * @param CakeText|array $alias String alias to convert back into a content type. Or an array of aliases to map.
 * @return CakeText|null Null on an undefined alias. String value of the mapped alias type. If an
 ...
 *
 * @param CakeText $type The type alias being converted, ie. json
 ...
 *
 * @param array|CakeText $type The type string or array with format `array('type' => 'viewClass')` to map one or more
 * @param array $viewClass The viewClass to be used for the type without `View` appended
 * @return array|CakeText Returns viewClass when only string $type is set, else array with viewClassMap
 */
