 ...
 *
 * @param CakeText $userAgent Set the userAgent
 * @return void
 */
 ...
 *
 * @param CakeText $name The name of the key your are setting in the session.
 * 							This should be in a Controller.key format for better organizing
 * @param CakeText $value The value you want to store in a session.
 * @return bool Success
 ...
 *
 * @param CakeText $name the name of the session key you want to read
 ...
 *
 * @param CakeText $name the name of the session key you want to delete
 ...
 *
 * @param CakeText $name the name of the session key you want to check
 ...
 *
 * @return CakeText Last session error
 */
 ...
 *
 * @param CakeText $message Message to be flashed
 * @param CakeText $element Element to wrap flash message in.
 * @param array $params Parameters to be sent to layout as view variables
 * @param CakeText $key Message key, default is 'flash'
 * @return void
 ...
 *
 * @param CakeText $id Id to use (optional)
 * @return CakeText The current session id.
 */
