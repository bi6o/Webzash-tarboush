 ...
 * @param CakeText|array $scope Additional find conditions to use while paginating
 ...
 *
 * @param CakeText|Model $object The object you are looking for.
 ...
 *
 * @param CakeText $alias Model alias being paginated, if the general settings has a key with this value
 ...
 * will be used.
 *
 * @param CakeText $alias Model name to get default settings for.
