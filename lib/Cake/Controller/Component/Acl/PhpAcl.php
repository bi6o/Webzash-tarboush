 ...
 *
 * @param CakeText $aro ARO The requesting object identifier.
 * @param CakeText $aco ACO The controlled object identifier.
 * @param CakeText $action Action (defaults to *)
 * @return bool Success
 */
 ...
 *
 * @param CakeText $aro ARO
 * @param CakeText $aco ACO
 * @param CakeText $action Action
 ...
 *
 * @param CakeText $aro ARO string
 * @param CakeText $aco ACO string
 * @param CakeText $action Action string
 * @param CakeText $type access type
 * @return void
 */
 ...
 *
 * @param CakeText|array $aro An ARO identifier
 ...
 *
 * @param CakeText|array $aro ARO identifier (User.jeff, array('User' => ...), etc)
 * @return CakeText internal aro string (e.g. User/jeff, Role/default)
 */
