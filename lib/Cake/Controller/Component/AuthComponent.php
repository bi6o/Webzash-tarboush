 ...
 *
 * @param CakeText|array $action Controller action name or array of actions
 * @return void
 ...
 *
 * @return CakeText AuthComponent::$logoutRedirect
 ...
 *
 * @param CakeText $key field to retrieve. Leave null to get entire User record
 ...
 *
 * @param CakeText|array $url Optional URL to write as the login redirect URL.
 * @return CakeText Redirect URL
 ...
 *
 * @param CakeText $password Password to hash
 * @return CakeText Hashed password
 ...
 *
 * @param CakeText $message The message to set.
 * @return void
 */
