 ...
 *
 * @param AclInterface|CakeText $adapter Instance of AclInterface or a string name of the class to use. (optional)
 ...
 *
 * @param array|CakeText|Model $aro ARO The requesting object identifier. See `AclNode::node()` for possible formats
 * @param array|CakeText|Model $aco ACO The controlled object identifier. See `AclNode::node()` for possible formats
