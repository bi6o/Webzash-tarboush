 ...
 *
 * @param CakeText $name Property name to check.
 * @return bool
 */
 ...
 *
 * @param CakeText $name The name of the requested value
 ...
 *
 * @param CakeText $name Property name to set.
 ...
 * @param int|CakeText $id Initial ID the instanced model class should have
 ...
 *
 * @param CakeText|array $url A string or array-based URL pointing to another location within the app,
 *     or an absolute URL
 ...
 * @param CakeText|array $url The same value of beforeRedirect
 ...
 *
 * @param CakeText $status The header message that is being set.
 * @return void
 ...
 * }}}
 *
 * @param CakeText $action The new action to be 'redirected' to.
 ...
 *
 * @param CakeText $view View to use for rendering
 ...
 *
 * @param CakeText $default Default URL to use if HTTP_REFERER cannot be read from headers
 * @param bool $local If true, restrict referring URLs to local server
 * @return CakeText Referring URL
 ...
 *
 * @param CakeText $message Message to display to the user
 * @param CakeText|array $url Relative string or array-based URL to redirect to after the time expires
 * @param int $pause Time to show the message
 * @param CakeText $layout Layout you want to use, defaults to 'flash'
 * @return void
 ...
 * @param CakeText|array $op A string containing an SQL comparison operator, or an array matching operators
 *        to fields
 * @param CakeText $bool SQL boolean operator: AND, OR, XOR, etc.
 ...
 *
 * @param Model|CakeText $object Model to paginate (e.g: model instance, or 'Model', or 'Model.InnerModel')
 * @param CakeText|array $scope Conditions to use while paginating
 ...
 *
 * @param CakeText $method name of method called example index, edit, etc.
 * @return bool Success
 ...
 *
 * @param CakeText $method Method name.
 * @return bool
 ...
 * This method should be overridden in child classes.
 *
 * @param CakeText $method name of method called either edit or update.
 * @return bool Success
 * @link http://book.cakephp.org/2.0/en/controllers.html#callbacks
 */
