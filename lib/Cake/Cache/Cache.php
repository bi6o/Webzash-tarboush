 ...
 *
 * @param CakeText $name Name of the configuration
 ...
 *
 * @param CakeText $name Name of the config array that needs an engine instance built
 * @return bool
 * @throws CacheException
 */
 ...
 *
 * @param CakeText $name A currently configured cache config you wish to remove.
 ...
 *
 * @param CakeText|array $settings Optional string for simple name-value pair or array
 * @param CakeText $value Optional for a simple name-value pair
 * @param CakeText $config The configuration name you are changing. Defaults to 'default'
 ...
 *
 * @param CakeText $config [optional] The config name you wish to have garbage collected. Defaults to 'default'
 ...
 *
 * @param CakeText $key Identifier for the data
 * @param mixed $value Data to be cached - anything except a resource
 * @param CakeText $config Optional string configuration name to write to. Defaults to 'default'
 ...
 *
 * @param CakeText $key Identifier for the data
 * @param CakeText $config optional name of the configuration to use. Defaults to 'default'
 ...
 * @param CakeText $config Optional string configuration name. Defaults to 'default'
 ...
 *
 * @param CakeText $key Identifier for the data
 * @param CakeText $config name of the configuration to use. Defaults to 'default'
 ...
 *
 * @param CakeText $group name of the group to be cleared
 * @param CakeText $config name of the configuration to use. Defaults to 'default'
 ...
 *
 * @param CakeText $name Name of the configuration to get settings for. Defaults to 'default'
 ...
 *
 * @param CakeText $group group name or null to retrieve all group mappings
 ...
 * }}}
 *
 * @param CakeText $key The cache key to read/store data at.
 ...
 * @param CakeText $config The cache configuration to use for this operation.
 *   Defaults to default.
