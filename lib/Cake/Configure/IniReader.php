 ...
 *
 * @param CakeText $path Path to load ini config files from. Defaults to APP . 'Config' . DS
 * @param CakeText $section Only get one section, leave null to parse and fetch
 ...
 *
 * @param CakeText $key The identifier to read from. If the key has a . it will be treated
 ...
 *
 * @param CakeText $key The identifier to write to. If the key has a . it will be treated
 *  as a plugin prefix.
 ...
 * @return CakeText String value for ini file.
 */
 ...
 * @param CakeText $key The identifier to write to. If the key has a . it will be treated
 *  as a plugin prefix.
 * @return CakeText Full file path
 */
